...
1. Fai clic su **[!UICONTROL Share]**. Se il progetto è già stato condiviso, fai clic su [!UICONTROL **Aggiorna**].)
   ...
   Clic **[!UICONTROL Curate and Share]** per applicare automaticamente la cura del progetto. Se il progetto è già stato condiviso, fai clic su **[!UICONTROL Curate & Update]**.) Ulteriori informazioni sulla [cura dei progetti](curate.md).
...
* Se a un destinatario non viene assegnato un ruolo e riceve un [link](/help/analysis-workspace/curate-share/shareable-links.md) al progetto (**[!UICONTROL Share]>[!UICONTROL Get project link]**), per impostazione predefinita viene assegnato loro un ruolo. Gli amministratori ricevono **[!UICONTROL Can edit]** e i non amministratori **[!UICONTROL Can duplicate]**.
...
Puoi concedere [Accesso solo visualizzazione](/help/analysis-workspace/curate-share/view-only-projects.md) ai progetti Analysis Workspace per le persone che non hanno accesso al Customer Journey Analytics. Ciò può includere:

* Persone esterne all’organizzazione

* Persone all’interno dell’organizzazione per le quali non è stato eseguito il provisioning del Customer Journey Analytics

>[!NOTE]
>
>Quando condividi un collegamento pubblico tieni presente quanto segue:
>
>* L’amministratore di CJA può disabilitare la condivisione di un collegamento di accesso pubblico, come descritto in [Preferenze](/help/analysis-workspace/user-preferences.md). Se non riesci a condividere un collegamento pubblico come descritto in questa sezione, l’amministratore CJA ha disabilitato questa funzionalità.
>
...
1. Scegli se abilitare la seguente opzione di sicurezza (questa opzione può essere controllata dall’amministratore CJA):
   ...
   * **[!UICONTROL Require Experience Cloud authentication]:**
      ...
      Gli amministratori CJA possono impostare questa preferenza per l’azienda, come descritto in [Preferenze](/help/analysis-workspace/user-preferences.md). A seconda della configurazione di questa opzione da parte dell’amministratore, potrebbero verificarsi gli scenari seguenti:

      * Se questa opzione non è visibile, l’amministratore di CJA non ha abilitato questa funzione.

      * Se questa opzione è abilitata e disabilitata, l’amministratore CJA richiede l’autenticazione Experience Cloud per accedere a tutti i collegamenti pubblici.
