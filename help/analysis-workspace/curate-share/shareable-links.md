...
Per condividere un collegamento a un progetto, passa al progetto che desideri condividere, quindi seleziona vai a **[!UICONTROL Condividi]** > **[!UICONTROL Ottieni collegamento progetto]** (o **[!UICONTROL Condividi]** > **[!UICONTROL Condividi con utenti Workspace]** > **[!UICONTROL Condividi tramite collegamento]**). Gli utenti con cui condividi il collegamento devono effettuare l’accesso.

Se al destinatario del collegamento non è stato assegnato un ruolo di [progetto](/help/analysis-workspace/curate-share/share-projects.md), gli amministratori riceveranno **[!UICONTROL Modifica originale]** e i non amministratori **[!UICONTROL Modifica copia]** esperienze.
...
* Dal menu di scelta rapida dell&#39;intestazione di un pannello, selezionare **[!UICONTROL Ottieni collegamento pannello]**
* Dal menu di scelta rapida di un&#39;intestazione di visualizzazione, selezionare **[!UICONTROL Ottieni collegamento visualizzazione]**

>[!BEGINSHADEBOX]

Consulta ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Collegamento all&#39;interno o all&#39;esterno del progetto](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/intra-linking-in-analysis-workspace.html?lang=it){target="_blank"} per un video dimostrativo.
...
Un suggerimento per sfruttare le varie opzioni di collegamento è quello di includere sempre un [sommario](/help/analysis-workspace/build-workspace-project/project-table-of-contents.md) nella parte superiore del progetto Workspace. Nel sommario puoi inserire collegamenti ad altri progetti rilevanti, pannelli specifici e visualizzazioni specifiche. In questo modo il destinatario del progetto potrà navigare più facilmente.
