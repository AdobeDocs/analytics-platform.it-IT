---
description: Elenco dei messaggi di errore in Analysis Workspace e nei relativi componenti
...
| [!UICONTROL Error 500: Failed to load page] | I problemi relativi alla rete locale, come le [impostazioni del firewall](https://experienceleague.adobe.com/docs/analytics/technotes/ip-addresses.html?lang=it-IT) aziendale, contribuiscono a questo errore. Inoltre,  Adobe potrebbe rilevare un problema da risolvere. | Prova a eseguire di nuovo l’accesso dopo alcuni minuti. Se il problema persiste, invia il codice ID istanza EIM all’Assistenza clienti. |
