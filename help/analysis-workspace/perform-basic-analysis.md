...
* Dimostra la dimensione del pubblico in base alle origini dati, ad esempio i dati ad impression, i dati Adobe  Analytics, i dati e-mail, i dati POS, i dati del call center e i dati del sondaggio.
