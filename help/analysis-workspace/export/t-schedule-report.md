...
![Nella finestra Invia file e nelle opzioni di pianificazione vengono visualizzate le impostazioni Inizio, Fine e Frequenza giornaliera.](assets/send-file.JPG)
...
>[!NOTE]
>
>L&#39;opzione per proteggere un progetto pianificato tramite password viene visualizzata solo per i clienti del Customer Journey Analytics che hanno acquistato il componente aggiuntivo [Healthcare Shield](https://business.adobe.com/solutions/industries/healthcare.html).
