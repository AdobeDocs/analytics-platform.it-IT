...
| [Tabella coorte](/help/analysis-workspace/visualizations/cohort-table/cohort-analysis.md) | Una *`cohort`* è un gruppo di persone che condividono le stesse caratteristiche per un determinato periodo di tempo. L’analisi per coorte è utile per le analisi di fidelizzazione, abbandono o latenza. |
...
| [Flusso](/help/analysis-workspace/visualizations/c-flow/flow.md) | Mostra i percorsi esatti dei clienti attraverso i tuoi siti web e le tue app. |
...
| [Istogramma](/help/analysis-workspace/visualizations/histogram.md) | Un istogramma esegue il bucket di visitatori, visite o hit in blocchi in base a un volume di metrica. |
...
| [Variazione di riepilogo](/help/analysis-workspace/visualizations/summary-number-change.md) | Mostra la variazione tra le celle selezionate come 1 numero/percentuale grande. |
...
| [Scaricare dati come CSV](/help/analysis-workspace/curate-share/download-send.md) | Scarica l’origine dati di visualizzazione come CSV. |
...
Se non sai quale visualizzazione scegliere, fai clic sull’icona **[!UICONTROL Create Visual]** in una delle righe della tabella (disponibile al passaggio del mouse). Questo è il modo più veloce per aggiungere una visualizzazione. Facendo clic su di essa, Analysis Workspace cerca di fare una stima ragionata per individuare la visualizzazione più idonea ai tuoi dati. Ad esempio, se hai selezionato 1 riga, verrà creato un grafico a linee con tendenze. Se sono state selezionate 3 righe di filtro, verrà creato un diagramma di Venn.
