...
*Questo articolo documenta la visualizzazione Punto elenco in **Customer Journey Analytics**.<br/>Consulta [Bullet](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/visualizations/bullet-graph) per la versione **Adobe Analytics**di questo articolo.*
