---
description: Creare una tabella coorte ed eseguire un’analisi per coorte in Analysis Workspace.
...
1. (Facoltativo) Crea un filtro o un pubblico da una selezione.
   ...
   ![Crea filtro o pubblico](assets/retention-createfilter.png)

1. Nel [Generatore di filtri](/help/components/filters/filter-builder.md), modificare ulteriormente il filtro, quindi fare clic su **[!UICONTROL Save]**.
