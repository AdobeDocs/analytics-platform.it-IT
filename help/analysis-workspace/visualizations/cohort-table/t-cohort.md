...
1. (Facoltativo) Creare un filtro da una selezione.
...
1. In [Filtro Builder](/help/components/filters/manage-filters.md), modificare ulteriormente il segmento, quindi fare clic su **[!UICONTROL Save]**.

   Il filtro salvato è disponibile per l&#39;uso nel pannello [!UICONTROL Filter] in [!UICONTROL Analysis Workspace].
