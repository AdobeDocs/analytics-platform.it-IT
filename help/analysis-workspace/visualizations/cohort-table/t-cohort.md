...
1. In [Filtro Builder](https://docs.adobe.com/content/help/it-IT/analytics/components/segmentation/segmentation-workflow/seg-build.html), modificare ulteriormente il segmento, quindi fare clic su **[!UICONTROL Save]**.
