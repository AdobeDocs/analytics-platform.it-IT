...
1. Nel [Generatore di filtri](/help/components/filters/filter-builder.md), modificare ulteriormente il segmento, quindi fare clic su **[!UICONTROL Save]**.

   Il segmento salvato è disponibile per l’utilizzo nel pannello [!UICONTROL Filter] di [!UICONTROL Analysis Workspace].
