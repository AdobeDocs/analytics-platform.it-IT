...
*Questo articolo documenta la visualizzazione Linee in **Customer Journey Analytics**.<br/>Vedere [Riga](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/visualizations/line) per la versione **Adobe Analytics**di questo articolo.*
