...
*Questo articolo documenta il pannello Quick Insights in **Customer Journey Analytics**. Consulta [Pannello Quick Insights](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/panels/quickinsight) per la versione **Adobe Analytics**di questo articolo.*
