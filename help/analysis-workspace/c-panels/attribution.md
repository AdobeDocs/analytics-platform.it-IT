...
*Questo articolo documenta il pannello Attribuzione in **Customer Journey Analytics**.<br/>Consulta [Pannello di attribuzione](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/panels/attribution) per la versione **Adobe Analytics**di questo articolo.*
