...
* Seleziona una cartella da rinominare nell’[Elenco progetti](/help/analysis-workspace/build-workspace-project/freeform-overview.md#project-list).
   ...
   1. Seleziona **[!UICONTROL Rinomina]** dalle [azioni](/help/analysis-workspace/build-workspace-project/freeform-overview.md#actions) disponibili nel menu di scelta rapida ![Altro](/help/assets/icons/More.svg) della cartella selezionata o nella barra blu delle azioni.
   1. Nella finestra di dialogo **[!UICONTROL Rinomina: *nome cartella *]**, immetti un nuovo nome e seleziona&#x200B;**[!UICONTROL Salva &#x200B;]**.

* All’interno della cartella che desideri rinominare.

   1. Selezionare **[!UICONTROL Rinomina cartella]** da ![Altro](/help/assets/icons/More.svg) nell&#39;area [Titolo](/help/analysis-workspace/build-workspace-project/freeform-overview.md#title-area).

   1. Nella finestra di dialogo **[!UICONTROL Rinomina: *nome cartella *]**&#x200B;immettere un nuovo nome e selezionare&#x200B;**[!UICONTROL Salva &#x200B;]**.
...
* Seleziona una cartella da spostare nell’[Elenco progetti](/help/analysis-workspace/build-workspace-project/freeform-overview.md#project-list).
   ...
   1. Seleziona **[!UICONTROL Sposta in]** dalle [azioni](/help/analysis-workspace/build-workspace-project/freeform-overview.md#actions) disponibili nel menu di scelta rapida ![Altro](/help/assets/icons/More.svg) della cartella selezionata o nella barra delle azioni blu.
   1. Nella finestra di dialogo **[!UICONTROL Seleziona cartella]**, seleziona una cartella dal menu a discesa **[!UICONTROL Cartella]** in cui spostare la cartella.

   1. Seleziona **[!UICONTROL Sposta]**.

* All’interno della cartella che desideri spostare.

   1. Seleziona **[!UICONTROL Sposta cartella]** da ![Altro](/help/assets/icons/More.svg) nell&#39;area [Titolo](/help/analysis-workspace/build-workspace-project/freeform-overview.md#title-area).
...
* Seleziona una o più cartelle da eliminare nell’[Elenco progetti](/help/analysis-workspace/build-workspace-project/freeform-overview.md#project-list).
   ...
   1. Seleziona **[!UICONTROL Elimina]** dalle [azioni](/help/analysis-workspace/build-workspace-project/freeform-overview.md#actions) disponibili nel menu di scelta rapida ![Altro](/help/assets/icons/More.svg) della cartella selezionata o nella barra delle azioni blu.

   1. In **[!UICONTROL Continuare?]** , selezionare **[!UICONTROL OK]** per eliminare le cartelle.

* All’interno della cartella che desideri eliminare.

   1. Seleziona **[!UICONTROL Elimina cartella]** da ![Altro](/help/assets/icons/More.svg) nell&#39;area [Titolo](/help/analysis-workspace/build-workspace-project/freeform-overview.md#title-area).

   1. Nella cartella **[!UICONTROL Elimina *nome*?]** , selezionare **[!UICONTROL OK]**.
