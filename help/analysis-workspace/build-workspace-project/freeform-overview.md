...
| **[!UICONTROL Title and description]** | Per modificare il progetto, selezionare il collegamento del titolo, che apre il [progetto Workspace](/help/analysis-workspace/home.md). I progetti condivisi con te sono indicati con ![Condividi](/help/assets/icons/Share.svg). Seleziona ![InfoOutline](/help/assets/icons/InfoOutline.svg) per visualizzare un menu a comparsa con ulteriori dettagli sul progetto. Seleziona ![Altro](/help/assets/icons/More.svg) per aprire un menu di scelta rapida con azioni. Vedi [Azioni](#actions) per ulteriori dettagli. |
...
| ![Condividi](/help/assets/icons/Share.svg) **[!UICONTROL Share]** | Condividere un progetto. Per ulteriori informazioni, vedere [Condividi progetto](/help/analysis-workspace/curate-share/share-projects.md). |
