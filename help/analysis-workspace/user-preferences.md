...
1. In Customer Journey Analytics, vai alla pagina di destinazione [!UICONTROL **Project**] (Progetto), quindi seleziona [!UICONTROL **Preferences**] (Preferenze).
