...
| | Consenti commenti sui progetti | Quando questa opzione è abilitata, nella barra a destra di ciascun progetto in Analysis Workspace è disponibile un’area commenti. <p>I proprietari dei progetti possono disabilitare l&#39;area commenti per un determinato progetto, come descritto in [Crea progetti](/help/analysis-workspace/build-workspace-project/create-projects.md).</p> <p>Per ulteriori informazioni sui commenti nei progetti Analysis Workspace, vedere [Aggiungere e gestire commenti nei progetti](/help/analysis-workspace/build-workspace-project/comment-projects.md).</p> |
