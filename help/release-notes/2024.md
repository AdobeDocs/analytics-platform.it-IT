...
## Fine ottobre 2024 {#nov24}

| Funzione | Descrizione | [Avvio del rollout](releases.md) | [Disponibilità generale](releases.md) |
| ----------- | ---------- | ------- | ---- |
| **Trasferimento risorse** | Consente di trasferire ad altri utenti la proprietà di componenti quali progetti, segmenti e metriche calcolate, in modo da garantire la continuità e l’accesso appropriato. [Ulteriori informazioni](/help/tools/asset-transfer/transfer-assets.md) |  | 15 ottobre |
...
| **Utilizzo prodotto** | Scopri come la tua organizzazione utilizza Customer Journey Analytics. Abilitando questa funzione viene creato un set di dati in Adobe Experience Platform che raccoglie dati quando un utente dell’organizzazione utilizza Analysis Workspace. Vengono inoltre create automaticamente una connessione e una visualizzazione dati, che consentono di accedere a dimensioni quali i principali tipi di progetto, gli utenti più attivi e i componenti più popolari utilizzati nei progetti. [Ulteriori informazioni](https://experienceleague.adobe.com/it/docs/analytics-platform/using/tools/product-usage/usage-overview) | 23 ottobre 2024 | Gennaio 2025 |
| **Visualizzazione dell’area di lavoro del percorso** | L’area di lavoro del percorso è una visualizzazione in Analysis Workspace che consente di analizzare il modo in cui le persone proseguono o abbandonano un percorso definito. Crea analisi dei percorsi degli utenti realizzando un grafico flessibile con nodi e frecce che rappresentano qualsiasi combinazione di eventi, elementi dimensionali e segmenti. Trascina i nodi nell’area di lavoro per riorganizzare gli eventi e le condizioni del percorso. Man mano che procedi, i dati vengono aggiornati di conseguenza.<p>La clientela con accesso a Adobe Journey Optimizer può analizzare i percorsi Journey Optimizer esistenti.<p>Per ulteriori informazioni sull’area di lavoro del percorso, consulta la [Panoramica sull’area di lavoro del percorso](https://experienceleague.adobe.com/it/docs/analytics-platform/using/cja-workspace/visualizations/journey-canvas/journey-canvas).<p>Per informazioni su come creare una visualizzazione dell’area di lavoro del percorso, consulta [Configurare l’area di di lavoro del percorso](https://experienceleague.adobe.com/it/docs/analytics-platform/using/cja-workspace/visualizations/journey-canvas/configure-journey-canvas). | 2 ottobre 2024 | 14 ottobre 2024 |
| **I segmenti del pannello e i segmenti di colonna sono ora inclusi durante la creazione di un pubblico** | Durante la creazione di un pubblico da una visualizzazione all’interno di Analysis Workspace, i segmenti di pannello e i segmenti di colonna ora sono inclusi come criteri aggiuntivi. Se i segmenti non sono necessari, possono essere rimossi prima di pubblicare il pubblico. In precedenza, tutti i segmenti applicati al pannello o alla colonna di una visualizzazione in Analysis Workspace venivano ignorati durante la creazione di un pubblico.<p>Per informazioni su come creare un pubblico da un Customer Journey Analytics, consulta [Creare e pubblicare tipi di pubblico](https://experienceleague.adobe.com/it/docs/analytics-platform/using/cja-components/audiences/publish). |  | 2 ottobre 2024 |

### Correzioni in Customer Journey Analytics

AN-354085; AN-355870; AN-356037; AN-356881; AN-357100; AN-358193; AN-358364; AN-358911; AN-359000; AN-359160

## Settembre 2024 {#sep24}
...
| **Analisi guidata: incorporare in Workspace** | Combina più analisi guidate in un’unica vista in Analysis Workspace. Il link alla documentazione seguirà a breve. | 2 ottobre 2024 | 31 ottobre 2024 |
...
| **Priorità di acquisizione e latenza** | Ora è possibile acquisire i dati degli eventi in Customer Journey Analytics entro 90 minuti (SLT), indipendentemente dal fatto che i dati abbiano 24 o 48 ore, oppure 7 giorni. Tieni presente che questa funzionalità varia in base al pacchetto SKU acquistato dalla tua azienda:<ul><li>Acquisizione priorità di Customer Journey Analytics di base: dati di 24 ore entro l’elaborazione di 90 minuti SLT (disponibile per Customer Journey Analytics Foundation e Customer Journey Analytics Select)</li><li>Acquisizione priorità di Customer Journey Analytics intermedia: dati di 72 ore entro l’elaborazione di 90 minuti SLT (disponibile per Customer Journey Analytics Prime)</li><li>Acquisizione priorità di Customer Journey Analytics avanzata: dati di 1 settimana entro l’elaborazione di 90 minuti SLT (disponibile per Customer Journey Analytics Ultimate)</li></ul> |  | 12 giugno 2024 |
...
| **Miglioramento delle autorizzazioni per i [!UICONTROL componenti di Workspace] solo progetto** | In precedenza, se un utente (utente A) condivideva un progetto con un altro utente (utente B) e dava a questo l’accesso per la modifica al progetto, l’utente B sarebbe stato in grado di modificare il progetto. Tuttavia, l&#39;utente B non potrà modificare [!UICONTROL i filtri rapidi] incorporati nel progetto. Questa limitazione è ora rimossa. L’utente B può modificare i [filtri rapidi](/help/components/segments/seg-quick.md) e altri componenti di solo progetto incorporati nel progetto condiviso. |  | 17 aprile 2024 |
...
| **Adobe Product Analytics: matrice delle funzioni** | Alimenta le decisioni di investimento capendo quali sono le funzioni principali, di potenza, singole e discutibili. [!UICONTROL La matrice delle funzionalità] misura gli eventi in base alla frequenza di utilizzo rispetto a % utenti attivi e confronta con l&#39;utilizzo mediano. | 17 aprile 2024 | 30 aprile 2024 |
| **Adobe Product Analytics: informazioni approfondite migliorati nel funnel** | Nella vista [Funnel](/help/guided-analysis/types/funnel.md), le informazioni scritte sono state ottimizzate per includere categorie, variazioni e descrizioni al fine di migliorare ulteriormente la comprensione del grafico e della tabella. | 17 aprile 2024 | sabato 26 aprile 2024 |
| **Adobe Product Analytics: visualizzazione di conservazione avanzata** | Sono state aggiunte diverse funzionalità alla vista [Conservazione](/help/guided-analysis/types/retention.md) per informazioni più approfondite e personalizzabili sulla conservazione:<ul><li>Scollega eventi di inizio e di ritorno</li><li>Confrontare più eventi di ritorno in un’unica vista</li><li>Personalizzare il modello di conservazione applicato con impostazioni su o dopo (non limitato), su ciascuna (limitato) e tra parentesi</li><li>Mostrare e nascondere singole righe della coorte nel grafico</li></ul> | giovedì 24 aprile 2024 | giovedì 8 maggio 2024 |
| **Adobe Product Analytics: confrontare eventi all’interno di un singolo passaggio funnel** | Ora puoi confrontare gli eventi all’interno di un singolo passaggio funnel nella vista [Funnel](/help/guided-analysis/types/funnel.md). Questa funzione è particolarmente utile quando il percorso dispone di opzioni per i passaggi o di un passaggio in cui viene eseguito un esperimento A/B. | 23 aprile 2024 | 3 maggio 2024 |
...
| **Campi derivati: funzione Successivo o Precedente** | Queste nuove funzioni consentono di prendere un campo come input e quindi identificare il valore n-precedente o n-successivo per ottenere una migliore visualizzazione nel percorso utente. Questa funzionalità può anche essere combinata con altre funzioni in [!UICONTROL Campi derivati], ad esempio [!UICONTROL Concatenare], per creare nuove dimensioni. |  | 1° maggio 2024 |
...
| **Nuova colonna disponibile nella pagina di destinazione Progetti** | La colonna **[!UICONTROL Ultimo utilizzo]** è ora disponibile quando si visualizza la scheda Progetti nella [pagina di destinazione di Customer Journey Analytics](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/landing.html?lang=it). <p>Queste informazioni possono essere utili per determinare se un progetto è utile per gli utenti dell’organizzazione, mostrando la data e l’ora dell’ultima apertura del progetto. In precedenza, la colonna **[!UICONTROL Ultimo utilizzo]** era disponibile solo nella gestione metriche calcolate, nella gestione segmenti e nella gestione avvisi.</p> |  | 13 marzo 2024 |
