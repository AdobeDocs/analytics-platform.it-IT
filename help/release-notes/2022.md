...
| ----------- | ---------- | ----- | --- |
| **[!UICONTROL Riepilogo delle metriche chiave] visualizzazione** | La visualizzazione del [!UICONTROL riepilogo delle metriche chiave] consente di vedere come si presenta una metrica importante in un singolo arco temporale. Consente inoltre di confrontare le prestazioni delle metriche in due archi temporali. [Ulteriori informazioni](/help/analysis-workspace/visualizations/key-metric.md) | 5 ottobre 2022 | 19 ottobre 2022 |
...
| **[!UICONTROL Rilevamento delle anomalie] condizioni di esecuzione automatica** | 29 settembre 2022 | Oggi, [!UICONTROL Rilevamento delle anomalie] viene eseguito automaticamente su tutte le colonne delle tabelle a forma libera con serie temporale. Affinché i dati possano essere rapidamente disponibili per l&#39;analisi e per velocizzare il caricamento dei progetti, in Adobe verrà modificato il modo in cui viene eseguito automaticamente il rilevamento delle anomalie]. [!UICONTROL A partire dal **26 ottobre 2022**, il rilevamento delle anomalie viene eseguito automaticamente solo sulla prima colonna di metriche di una tabella. Se necessario, è possibile configurare le impostazioni delle colonne per eseguire [!UICONTROL Rilevamento anomalie] su altre colonne. |
...
| [!UICONTROL Elemento successivo] o [!UICONTROL Elemento precedente] Pannello Workspace | Il pannello [!UICONTROL Elemento successivo o precedente] consente di esplorare gli elementi che seguono o precedono un elemento dimensionale scelto. Ad esempio, utilizzalo se desideri visualizzare le pagine successive o precedenti in una pagina di prodotto specifica, in un canale di marketing o persino in un tipo di dispositivo. Questo pannello va oltre il reporting legacy precedente/successivo, perché consente di esaminare qualsiasi dimensione e non richiede alcuna nuova implementazione per ottenere informazioni approfondite. | 20 aprile 2022 |

{style="table-layout:auto"}

### Correzioni

* È stato corretto un errore della console che si verificava durante l&#39;accesso a Customer Journey Analytics dalla home page di CX Enterprise. (AN-281468)
...
| Modelli di allocazione [!UICONTROL Primo noto] e [!UICONTROL Ultimo noto] | Questi due nuovi modelli di allocazione considerano il primo o l’ultimo valore osservato per una dimensione all’interno di un ambito di persistenza specificato (sessione, persona o periodo di tempo personalizzato con look-back). Quindi applicano il modello di allocazione a tutti gli eventi all’interno dell’ambito specificato. [Ulteriori informazioni](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/component-settings/persistence.html?lang=it#allocation-settings) | 19 gennaio 2022 |
