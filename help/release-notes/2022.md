...
| **Variabili con più valori senza distinzione tra maiuscole e minuscole** | Per le variabili con più valori senza distinzione tra maiuscole e minuscole, i valori memorizzati in `mvvar1` - `mvvar3` non verranno più convertiti automaticamente in minuscole. Al contrario, i dati trasmessi dal connettore di origine di Analytics a Adobe Experience Platform e Customer Journey Analytics rifletteranno le maiuscole e minuscole originali trasmesse dalla pagina. Colonne del connettore di origine e del Customer Journey Analytics `_experience.analytics.customDimensions.lists.list1.list[]` - `_experience.analytics.customDimensions.lists.list3.list[]` sono interessati da questa modifica. | N/D | 24 ottobre 2022 |
...
| **Variabili con più valori senza distinzione tra maiuscole e minuscole** | Per le variabili con più valori senza distinzione tra maiuscole e minuscole, i valori memorizzati in `mvvar1` - `mvvar3` non verranno più convertiti automaticamente in minuscole. Al contrario, i dati trasmessi dal connettore di origine di Analytics a Adobe Experience Platform e Customer Journey Analytics rifletteranno le maiuscole e minuscole originali trasmesse dalla pagina. | 24 ottobre 2022 |
