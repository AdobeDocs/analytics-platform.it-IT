...
| --- | --- |
| **Luglio 2024** | |
| Messaggi di errore comuni aggiornati | Sono stati apportati aggiornamenti minori al [messaggi di errore comuni](/help/analysis-workspace/workspace-faq/error-messages.md). |
| **Giugno 2024** | |
| Nome del prodotto aggiornato che fa riferimento alle funzioni streaming media | Le istanze di “Media Analytics” e “Streaming Media” sono state sostituite con il nome “Componente aggiuntivo Streaming Media Collection” quando si fa riferimento all’insieme di funzioni streaming media che raccolgono dati per contenuti multimediali in streaming e li presentano in Analysis Workspace. <p>Questi aggiornamenti sono disponibili nell&#39;intera documentazione del Customer Journey Analytics e nella [Documentazione del componente aggiuntivo Streaming Media Collection](https://experienceleague.adobe.com/it/docs/media-analytics/using/media-overview).</p> |
| Unione basata su grafo | Aggiornato e ristrutturato [documentazione sull’unione](/help/stitching/overview.md) con l’introduzione dell’unione basata su grafico. |
...
| Casi d’uso per l’esportazione di dati | Set di nuovi articoli che descrivono [casi d’uso per l’esportazione di dati](/help/use-cases/data-export/overview.md) e come utilizzare le funzionalità di Experience Platform e Customer Journey Analytics per implementare questi casi d’uso |
...
| Esempi di connettori sorgente | Sono stati aggiunti esempi di connettori sorgente disponibili per la descrizione di come [utilizzare un connettore di origine](/help/data-ingestion/sources.md#use-a-source-connector) per l’acquisizione dei dati. |
| **Aprile 2024** | |
...
| È stata aggiunta la documentazione sui sottotitoli intelligenti nelle scorecard per dispositivi mobili | [Sottotitoli intelligenti](https://experienceleague.adobe.com/it/docs/analytics-platform/using/cja-dashboards/manage-scorecard#captions) può aiutare i non analisti a dare un senso migliore ai propri dati senza l’aiuto degli analisti. |
| Nuova documentazione per le funzioni di Adobe Product Analytics | <ul><li>[Matrice di funzioni](https://experienceleague.adobe.com/it/docs/analytics-platform/using/guided-analysis/funnel/friction)</li><li>Avanzato [percentuali di conservazione](https://experienceleague.adobe.com/it/docs/analytics-platform/using/guided-analysis/retention/retention-rates)</li><li>[Approfondimenti migliorati in Funnel](https://experienceleague.adobe.com/it/docs/analytics-platform/using/guided-analysis/funnel/friction)</li><li>Confrontare gli eventi all’interno di un singolo passaggio Funnel</li></ul> |
| **Marzo 2024** | |
...
| È stato chiarito che gli amministratori di prodotto hanno sempre accesso all’esportazione di tabelle complete | Sono state apportate le seguenti modifiche per chiarire che gli utenti a cui è assegnato il ruolo di amministratore prodotto hanno accesso all’esportazione di tabelle complete da Analysis Workspace per impostazione predefinita: <ul><li>È stato aggiunto un nuovo punto elenco a [Autorizzazioni predefinite per l’amministratore del prodotto](/help/technotes/access-control.md#product-admin-default-permissions).</li><li>È stata aggiunta una nota sotto [requisiti minimi per l’esportazione di tabelle complete nel cloud](/help/analysis-workspace/export/export-cloud.md#minimum-requirements).</li></ul> |
| È stato chiarito che i segmenti vengono ricreati durante la migrazione dei componenti da Adobe Analytics | In [Guida utente per gli utenti di Adobe Analytics](/help/getting-started/aa-to-cja-user.md), ha chiarito che i segmenti vengono ricreati automaticamente in Adobe Analytics come parte del processo di migrazione dei componenti e non devono essere ricreati manualmente. |
...
| Autorizzazioni necessarie per esportare i set di dati | Sono state aggiunte informazioni che spiegano [autorizzazioni richieste](/help/technotes/access-control.md) per esportare i set di dati nelle destinazioni cloud. |
...
| Guardrail | Customer Journey Analytics di voci aggiunto [guardrail](../technotes/guardrails.md). |
...
| Confronto con Adobe Analytics | È stato aggiunto un [pagina panoramica](../getting-started/aa-vs-cja/overview.md) come introduzione sul confronto e sulla comprensione delle differenze tra Customer Journey Analytics e Adobe Analytics. |
...
| Miglioramenti al Report Builder | <ul><li>[Filtra da cella per più blocchi di dati](/help/report-builder/select-data-view.md)</li><li>[Mostrare e nascondere le intestazioni di riga e di colonna](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-reportbuilder/create-a-data-block.html?lang=it#build-the-data-block)</li></ul> |
| Ricerche geografiche di Edge Network | [Impostazioni dello stream di dati](https://experienceleague.adobe.com/docs/experience-platform/edge/datastreams/configure.html) in che modo dispone di un servizio di ricerca geografica che fornisce dati geografici unificati? |
| **Giugno 2023** | |
