...
| Assistente IA | Aggiunta [documentazione](../ai-assistant.md) sull&#39;Assistente di intelligenza artificiale per il Customer Journey Analytics. |
...
| È stata aggiornata la documentazione sugli intervalli di date personalizzati | Sono state aggiornate le schermate e le procedure relative a [intervalli di date di esempio](/help/components/date-ranges/custom-date-ranges.md) per corrispondere alle funzioni e alla progettazione del prodotto correnti. |
| Informazioni generali sui Dimension | Sono state aggiunte informazioni sulle [dimensioni](/help/components/dimensions/overview.md). |
| Esempi di connettori sorgente | Sono stati aggiunti esempi di connettori di origine disponibili quando si descrive come [utilizzare un connettore di origine](/help/data-ingestion/sources.md#use-a-source-connector) per l&#39;acquisizione dei dati. |
| **Aprile 2024** | |
...
| Sono state aggiunte informazioni sulla raccomandazione dell’esportazione di tabelle complete per dimensioni ad alta cardinalità | È stato aggiunto un punto elenco in [Best practice per le dimensioni ad alta cardinalità](/help/components/dimensions/high-cardinality.md) per consigliare l&#39;utilizzo di Esportazione tabella completa per le dimensioni ad alta cardinalità. |
| È stata aggiunta la documentazione sui sottotitoli intelligenti nelle scorecard per dispositivi mobili | [Didascalie intelligenti](https://experienceleague.adobe.com/it/docs/analytics-platform/using/cja-dashboards/manage-scorecard#captions) può aiutare i non analisti a dare un senso migliore ai loro dati senza l&#39;aiuto degli analisti. |
| Nuova documentazione per le funzioni di Adobe Product Analytics | <ul><li>[Matrice di funzionalità](https://experienceleague.adobe.com/it/docs/analytics-platform/using/guided-analysis/funnel/friction)</li><li>[percentuali di conservazione](https://experienceleague.adobe.com/it/docs/analytics-platform/using/guided-analysis/retention/retention-rates) migliorate</li><li>[Informazioni avanzate nel funnel](https://experienceleague.adobe.com/it/docs/analytics-platform/using/guided-analysis/funnel/friction)</li><li>Confrontare gli eventi all’interno di un singolo passaggio Funnel</li></ul> |
| **Marzo 2024** | |
...
| È stata aggiunta la documentazione sul miglioramento delle autorizzazioni per i componenti Workspace solo progetto | Se condividi un progetto con altri utenti, questi ultimi potranno modificare [filtri rapidi](/help/components/filters/quick-filters.md) e altri componenti di solo progetto incorporati nel progetto condiviso. |
| **Febbraio 2024** | |
...
| È stato chiarito che i segmenti vengono ricreati durante la migrazione dei componenti da Adobe Analytics | Nella [Guida utente per gli utenti di Adobe Analytics](/help/getting-started/aa-to-cja-user.md), è stato chiarito che i segmenti vengono ricreati automaticamente in Adobe Analytics come parte del processo di migrazione dei componenti e non è necessario ricrearli manualmente. |
...
| --- | --- |
| **Dicembre 2023** | |
| Data center | È stato aggiunto un articolo sul Customer Journey Analytics [posizioni di hosting](../technotes/data-centers.md). |
| Guardrail | È stato aggiunto un articolo che elenca il Customer Journey Analytics [guardrail](../technotes/guardrails.md). |
| Aggiornamenti della conversione valuta | È stata chiarita la documentazione su come [configurare la conversione della valuta](/help/data-views/component-settings/format.md). |
...
| **Ottobre 2023** | |
| Utilizzo di un campo derivato per l’impostazione di obiettivi/target | È stato aggiunto l&#39;articolo del [caso d&#39;uso](../use-cases/goals-using-derived-fields.md) che illustra come utilizzare i campi derivati per impostare obiettivi/target e generare rapporti su di essi. |
| Esporta tabelle complete nel cloud | È stata aggiunta la documentazione sull’esportazione di tabelle complete con milioni di righe Workspace nelle destinazioni cloud. <p>L’esportazione di tabelle complete offre la consegna singola o pianificata di tabelle di dati progettate in Workspace con supporto fino a cinque raggruppamenti, cinque metriche, filtri e metriche calcolate, il tutto in una tabella concatenata. È l’evoluzione dei rapporti Data Warehouse in Adobe Analytics, con molte nuove funzioni, spesso richieste, che oggi non sono disponibili in Data Warehouse.</p><p>Per ulteriori informazioni, consulta [Esportare rapporti di Customer Journey Analytics nel cloud](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-workspace/export/export-cloud.html?lang=it). |
| Reporting Activity Manager | È stata aggiunta la documentazione per Reporting Activity Manager. <p>Reporting Activity Manager ti consente di visualizzare la capacità di reporting per ogni connessione della tua organizzazione. Offre agli amministratori una visibilità dettagliata sul consumo di reporting per diagnosticare e risolvere facilmente i problemi di capacità durante i periodi in cui si verificano picchi di reporting.</p> <p>Sono stati aggiunti i seguenti nuovi articoli:<ul><li>[Panoramica di Reporting Activity Manager](/help/reporting-activity-manager/reporting-activity-overview.md)</li><li>[Visualizza attività di reporting in Reporting Activity Manager](/help/reporting-activity-manager/reporting-activity.md)</li><li>[Annullare le richieste in Reporting Activity Manager](/help/reporting-activity-manager/reporting-activity-cancel-requests.md)</ul> |
...
| Miglioramenti al Report Builder | È stato aggiornato il contenuto per [Pianificare le cartelle di lavoro](/help/report-builder/schedule-reportbuilder.md) per fornire informazioni per il download delle attività pianificate. È stato aggiornato il contenuto per [Creare un blocco di dati](/help/report-builder/create-a-data-block.md) per fornire informazioni sull&#39;utilizzo della data di inizio come dimensione. |
...
| Evoluzione da Adobe Analytics | Aggiornamento della sezione *(Re-)Configure Marketing Channels* con un riferimento al modello di funzione Campi derivati Marketing Channels. [Ulteriori informazioni](../getting-started/aa-to-cja.md#3-reconfigure-your-marketing-channels) |
...
| Adobe Product Analytics | Adobe Product Analytics è un nuovo modo di interagire con dati e approfondimenti cross-channel in Customer Journey Analytics. Queste nuove funzionalità consentono ai team di prodotto di gestire autonomamente dati e informazioni sulla propria esperienza di prodotto tramite [flussi di lavoro di analisi guidati](/help/guided-analysis/overview.md)&#x200B;. |
| Campi derivati | Un [campo derivato](/help/data-views/derived-fields/derived-fields.md) ti consente di definire al volo manipolazioni di dati (spesso complesse) tramite un generatore di regole personalizzabile. |
| Supporto esteso della ricerca per i dati di profilo e di ricerca | Consente di aggiungere set di dati come ricerche di campi all’interno di set di dati di profilo o di ricerca. In precedenza erano supportati solo i set di dati evento. [Ulteriori informazioni](/help/connections/create-connection.md) |
| Miglioramenti al Report Builder | <ul><li>[Filtra da cella per più blocchi di dati](/help/report-builder/select-data-view.md)</li><li>[Mostra e nascondi intestazioni di riga e di colonna](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-reportbuilder/create-a-data-block.html?lang=it#build-the-data-block)</li></ul> |
| Ricerche geografiche di Edge Network | [Impostazioni dello stream di dati](https://experienceleague.adobe.com/docs/experience-platform/edge/datastreams/configure.html) come dispone di un servizio di ricerca geografica che fornisce dati geografici unificati. |
| **Giugno 2023** | |
...
| Aggiornamento della documentazione del pannello Sperimentazione | È stata aggiunta una sezione sull’[interpretazione di dimensioni non randomizzate](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-workspace/panels/experimentation.html#non-randomized). |
...
| Aggiornamento della documentazione di Audiences | Nuova sezione sulle [considerazioni sulla latenza](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-components/audiences/publish.html#latency). |
...
| Ottobre 2022 | Nuova sezione sulla [funzionalità data e ora nelle visualizzazioni dati](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/data-views-usecases.html#date) |
| Ottobre 2022 | App mobile: nuovo argomento sulle [visualizzazioni dettagli personalizzate](https://experienceleague.adobe.com/docs/analytics/analyze/mobapp/create-scorecard.html#view-detail-slides). |
...
| Giugno 2022 | Nuovo articolo su [Regole di elaborazione, VISTA e classificazioni rispetto alla preparazione dati per il connettore di origine di Adobe Analytics](/help/getting-started/aa-vs-cja/pr-vista-dataprep.md). |
...
| Data | Descrizione aggiornamento |
| --- | --- |
| 13 novembre 2020 | Nuovi argomenti su [Analisi cross-channel](/help/stitching/overview.md), che consente di reimpostare l&#39;ID persona di un set di dati e consente di combinare direttamente più set di dati. |
