...
| Content Analytics | [Documentazione](/help/content-analytics/content-analytics.md) per Adobe Content Analytics. Content Analytics consente di analizzare in modo rapido e semplice grandi volumi di dati sui contenuti per scoprire tendenze, individuare anomalie, identificare il sovraccarico di contenuti e ottenere informazioni approfondite dall’esposizione dei contenuti. |
| **Marzo 2025** | |
...
| Trasferimento risorse | Consente di [trasferire la proprietà](https://experienceleague.adobe.com/it/docs/analytics-platform/using/tools/asset-transfer/transfer-assets) di componenti quali progetti, segmenti e metriche calcolate ad altri utenti per garantire la continuità e l&#39;accesso appropriato. |
...
| Workspace e componenti | È stata aggiornata la documentazione su progetti (progetti, visualizzazioni e pannelli) e componenti di Analysis Workspace (annotazioni, dimensioni, metriche (calcolate), segmenti, intervalli di date, avvisi, progetti pianificati e tipi di pubblico). |
...
| Informazioni aggiuntive nella colonna &quot;Usato in&quot; nel gestore metriche calcolate e nel gestore segmenti | La colonna &quot;Usato in&quot; in [Gestione metriche calcolate](https://experienceleague.adobe.com/it/docs/analytics-platform/using/cja-components/cja-calcmetrics/cm-workflow/cm-manager?lang=it) e [Gestione segmenti](https://experienceleague.adobe.com/it/docs/analytics-platform/using/cja-components/cja-filters/manage-filters?lang=it) contiene le nuove aree di reporting seguenti: Report Builder e componenti ad hoc |
| **Agosto 2024** | |
...
| Esportare tabelle complete nel cloud | È stata aggiunta la documentazione sull’esportazione di tabelle complete con milioni di righe Workspace nelle destinazioni cloud. <p>L’esportazione di tabelle complete offre la consegna una tantum o pianificata di tabelle di dati progettate in Workspace con supporto per fino a cinque raggruppamenti, cinque metriche, segmenti e metriche calcolate, il tutto in una tabella concatenata. È l’evoluzione dei rapporti Data Warehouse in Adobe Analytics, con molte nuove funzioni, spesso richieste, che oggi non sono disponibili in Data Warehouse.</p><p>Per ulteriori informazioni, consulta [Esportare rapporti di Customer Journey Analytics nel cloud](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-workspace/export/export-cloud.html?lang=it). |
...
| **Aprile 2023** |  |
| Video sull’utilizzo dei segmenti come dimensioni | È stato aggiornato il video sull’utilizzo dei segmenti come dimensioni. <p>Questo video è collegato dalla pagina [Crea segmenti](/help/components/filters/create-filters.md).</p> <p>Di seguito è riportato un collegamento diretto al video: [Utilizzare i segmenti come dimensioni in Analysis Workspace](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/components/filters/use-filters-as-dimensions.html?lang=it).</p> |
| Documentazione del segmento | È stato aggiunto un articolo sull&#39;utilizzo del [Generatore di segmenti](/help/components/filters/filter-builder.md). <p>Documentazione semplificata in [Crea segmenti](/help/components/filters/create-filters.md) e [Panoramica sulla segmentazione](/help/components/filters/filters-overview.md).</p> |
...
| Segmenti di progetto (segmenti ad hoc e rapidi) | Documentazione semplificata sui segmenti di progetto e rimozione delle informazioni duplicate. I passaggi per la creazione di segmenti ad hoc sono ora combinati con quelli per la [creazione di segmenti rapidi](/help/components/filters/quick-filters.md). |
| **Marzo 2023** | |
...
| **Ottobre 2021** | |
| Ottobre 2021 | Documentazione di [Report Builder](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-reportbuilder/report-buider-overview.html?lang=it#) in Customer Journey Analytics. |
