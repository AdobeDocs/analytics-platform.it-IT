...
I seguenti aggiornamenti sono stati apportati alla documentazione del Customer Journey Analytics fin dalla sua introduzione.
...
| Aggiornamenti delle metriche calcolate | Sono stati apportati i seguenti aggiornamenti alla documentazione sulle metriche calcolate per allinearla alle attuali funzionalità del Customer Journey Analytics: <ul><li>È stato aggiornato l’elenco di [metriche calcolate predefinite](/help/components/calc-metrics/default-calcmetrics.md) disponibile nel Customer Journey Analytics</li><li>Schermate e procedure sono state aggiornate in vari articoli sulle metriche calcolate </li></ul> |
| **Maggio 2023** | |
...
| Documentazione della schermata Home aggiornata per l’app delle dashboard di Analytics (app mobile) | La nuova schermata Home aggiornata consente di visualizzare tutte le scorecard in un unico elenco di scorecard consolidato. [Ulteriori informazioni](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dashboards/executive.html?lang=it#use-dashboards) |
| Aggiornamento dell’ottimizzazione | Articolo aggiornato il [Ottimizzazione delle prestazioni del Customer Journey Analytics](/help/admin/optimizing-performance.md) |
...
| Campi derivati | È stata aggiunta la documentazione per [campi derivati](../data-views/derived-fields/derived-fields.md) funzionalità. |
| **Aprile 2023** |  |
...
| **Marzo 2023** | |
| Integrare i dati di gestione delle decisioni | Sono stati aggiunti contenuti che spiegano come [integrare i dati di Adobe Journey Optimizer Decision Management nel Customer Journey Analytics](/help/integrations/ajo-od.md). |
...
| Supporto delle funzioni aggiornato | Aggiornato [Supporto delle funzioni del Customer Journey Analytics](/help/getting-started/aa-vs-cja/cja-aa.md) con una tabella delle funzioni disponibile in Customer Journey Analytics ma non disponibile o supportata in AA. |
...
| Aggiornamento della documentazione di Audiences | Dopo aver creato un pubblico, in Adobe viene creato un Experience Platform [segmento di streaming per ogni nuovo pubblico di Customer Journey Analytics](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-components/audiences/publish.html?lang=it#after-audience-created). |
...
| Scorecard per dispositivi mobili | Nuova sezione della documentazione per descrivere come mostrare e nascondere gli intervalli di date di confronto. Consulta [Mostra intervalli date di confronto](/help/mobile-app/create-scorecard.md#show-comparison-dates) nel Customer Journey Analytics. |
| **Gennaio 2023** | |
...
| Guide rapide per l’acquisizione dei dati | Nuova sezione della documentazione su come [acquisire e utilizzare dati](/help/data-ingestion/data-ingestion.md) nel Customer Journey Analytics. |
...
| Supporto di array di oggetti per i set di dati di profilo e ricerca | Aggiornato [Utilizzare gli array di oggetti](/help/use-cases/object-arrays.md) e [Acquisire il pubblico Adobe Experience Platform](/help/use-cases/data-ingestion/ingest-aep-segments.md) per riflettere il supporto dell’array di oggetti per i set di dati di profilo e di ricerca. |
...
| Ottobre 2022 | Nuovo argomento su [Registro di controllo del Customer Journey Analytics](/help/privacy/audit-log.md). |
...
| **Settembre 2022** | |
| Settembre 2022 | Nuovo caso d’uso il [Migrazione dei dati Google Analytics al Customer Journey Analytics](/help/use-cases/ga/overview.md). |
...
| Agosto 2022 | Articolo con aggiornamenti importanti su [Controllo dell’accesso al Customer Journey Analytics](/help/admin/cja-access-control.md). |
| Agosto 2022 | Nuovo articolo su [Supporto del Customer Journey Analytics per etichette e criteri per la governance dei dati](/help/data-views/data-governance.md). |
...
| Giugno 2022 | Nuovo articolo su [confronto dell’elaborazione dei dati tra Adobe Analytics e le funzioni di reporting di Customer Journey Analytics](/help/getting-started/aa-vs-cja/data-processing-comparisons.md). |
...
| **Maggio 2022** | |
| Maggio 2022 | Articolo con aggiornamenti importanti su [creazione di connessioni](/help/connections/create-connection.md) nel Customer Journey Analytics. |
...
| Maggio 2022 | Nuovo articolo su [acquisizione del pubblico Adobe Experience Platform nel Customer Journey Analytics](/help/use-cases/data-ingestion/ingest-aep-segments.md). |
| **Aprile 2022** | |
...
| Aprile 2022 | Nuovo [Guida utente di Customer Journey Analytics per gli utenti di Adobe Analytics](/help/getting-started/aa-to-cja-user.md). |
| **Marzo 2022** | |
| Marzo 2022 | Nuovo [Documentazione API per le annotazioni di Customer Journey Analytics](https://developer.adobe.com/cja-apis/docs/endpoints/annotations/). |
...
| **Gennaio 2022** | |
| Gennaio 2022 | Nuovo caso d’uso per [Utilizzo di dimensioni e metriche di binding nel Customer Journey Analytics](/help/use-cases/data-views/binding-dimensions-metrics.md) |
...
| Gennaio 2022 | Nuovo articolo su [confronto dei dati di Adobe Analytics con quelli di Analytics in Customer Journey Analytics](https://experienceleague.adobe.com/docs/analytics-platform/using/troubleshooting/compare.html?lang=it) |
...
| **Ottobre 2021** | |
| Ottobre 2021 | Documentazione per [Report Builder](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-reportbuilder/report-buider-overview.html?lang=it#) nel Customer Journey Analytics. |
...
| Settembre 2021 | Nuova sezione sulla [implicazioni dell’unione di suite di rapporti](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/cja-faq.html?lang=it#6-considerations-when-merging-report-suites-in-cja) nel Customer Journey Analytics. |
| **Agosto 2021** | |
| Agosto 2021 | Nuova sezione sulla versione [Connessioni](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/manage-connections.html?lang=it) esperienza nel Customer Journey Analytics. |
...
| Aprile 2021 | Nuovo argomento su [dimensioni ad alta cardinalità nel Customer Journey Analytics](/help/components/dimensions/high-cardinality.md). |
| **Marzo 2021** | |
...
| Febbraio 2021 | Pubblicato il nuovo [API CUSTOMER JOURNEY ANALYTICS](https://www.adobe.io/cja-apis/docs/) documentazione. |
| **Gennaio 2021** | |
...
| Dicembre 2019 | Prima bozza della documentazione del Customer Journey Analytics |
