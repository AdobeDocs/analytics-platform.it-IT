...
| **Supporto per il mirroring dei dati** | Grazie al supporto di schemi basati su modelli e alla funzionalità di modifica di acquisizione dati (CDC) per connettori di origine specifici in Experience Platform, Customer Journey Analytics sarà in grado di supportare la funzionalità di mirroring dei dati delle soluzioni data warehouse come [!DNL Snowflake], [!DNL Azure Databricks] e [!DNL Google BigQuery].<p>Contatta il team Adobe Account per accedere alla versione Beta.</p><p>Il collegamento alla documentazione seguirà a breve.</p> | Versione Beta: 24 settembre 2025 | Da definire |
