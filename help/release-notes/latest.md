...
| **Supporto per schemi ad hoc e basati su modelli** | [Gli schemi ad hoc](https://experienceleague.adobe.com/it/docs/experience-platform/xdm/tutorials/ad-hoc) e basati su modelli vengono utilizzati nei flussi di lavoro di mirroring e di acquisizione dati di Experience Platform. |  | 23 settembre 2025 (rilascio originariamente pianificato per il 28 agosto 2025) |
...
| **Supporto per il mirroring dei dati** | Grazie al supporto di schemi basati su modelli e alla modifica della funzionalità di acquisizione dati (CDC) per connettori di origine specifici in Experience Platform, Customer Journey Analytics sarà in grado di supportare la funzionalità di mirroring dei dati delle soluzioni data warehouse come [!DNL Snowflake], [!DNL Azure Databrick] e [!DNL Google BigQuery].<p>Contatta il team Adobe Account per accedere alla versione Beta.</p><p>Il collegamento alla documentazione seguirà a breve.</p> | Versione Beta, a partire dal 24 settembre 2025 | Da definire |
