...
| **Miglioramenti all&#39;area di lavoro di Percorso** <br/> I seguenti miglioramenti sono disponibili nelle visualizzazioni dell&#39;area di lavoro di Percorso: <ul><li>[Escludere i nodi](/help/analysis-workspace/visualizations/journey-canvas/configure-journey-canvas.md#exclude-nodes) da un percorso.</li><li>Utilizza i dati di abbandono di un nodo per [creare segmenti](/help/analysis-workspace/visualizations/journey-canvas/configure-journey-canvas.md#create-a-segment-based-on-a-node-or-arrow), [trend](/help/analysis-workspace/visualizations/journey-canvas/configure-journey-canvas.md#view-trend-data), [tipi di pubblico](/help/analysis-workspace/visualizations/journey-canvas/configure-journey-canvas.md#create-an-audience) e [raggruppamenti](/help/analysis-workspace/visualizations/journey-canvas/configure-journey-canvas.md#apply-a-breakdown).</li></ul> | | 18 maggio 2026 |
