...
| ----------- | ---------- | ------- | ---- |
| **Aggiornamenti all&#39;interfaccia di utilizzo** | L&#39;interfaccia [Usage](/help/connections/manage-connections.md#usage) ora aggiunge informazioni sul volume dei dati di base e sulle dimensioni medie delle righe.<p>Per ulteriori informazioni, vedere [Gestire le connessioni](/help/connections/manage-connections.md#usage).</p> | | venerdì 4 settembre 2025 |
...
| **Reporting in tempo reale** | Il reporting in tempo reale in Customer Journey Analytics mostra e aggiorna dati e visualizzazioni in uno o più pannelli di Analysis Workspace in tempo reale.<br/><br/>(Segui il link alla documentazione). | | 18 settembre 2025 (rilascio originariamente pianificato per il 15 agosto 2025) |
