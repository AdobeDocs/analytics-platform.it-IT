...
| **Supporto per schemi ad hoc e basati su modelli** | [Gli schemi ad hoc](https://experienceleague.adobe.com/it/docs/experience-platform/xdm/tutorials/ad-hoc) e basati su modelli vengono utilizzati nei flussi di lavoro di acquisizione dati e mirroring dati per Experience Platform. |  | mercoledì 23 settembre 2025 (rilascio originariamente pianificato per il 28 agosto 2025) |
| **Reporting in tempo reale** | Il reporting in tempo reale in Customer Journey Analytics mostra e aggiorna dati e visualizzazioni in uno o più pannelli di Analysis Workspace in tempo reale.<br/><br/>Il collegamento alla documentazione seguirà a breve. | 18 settembre 2025 (rilascio originariamente pianificato per il 15 agosto 2025) | giovedì 1 ottobre 2025 |
