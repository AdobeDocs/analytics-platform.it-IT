...
| **Data Insights Agent su Agent Orchestrator** <br/> Oltre a essere disponibile nella barra corretta in Customer Journey Analytics, Data Insights Agent è ora disponibile come parte di Agent Orchestrator. Ciò significa che ora puoi ottenere informazioni che si basano sui dati e sulle funzionalità di Customer Journey Analytics mentre lavori in altre app Experience Platform, ad esempio in Journey Optimizer.<p>In Customer Journey Analytics, Data Insights Agent include i seguenti miglioramenti:</p><ul><li>Un’esperienza utente più coerente con Agent Orchestrator</li><li>Sintesi dei paragrafi</li><li>Risposte alle domande &quot;perché&quot; tramite root cause analysis</li><li>Tabelle in linea</li><li>E molto di più!&lt;/l></ul><p>Il collegamento alla documentazione seguirà a breve.</p> | | Fine di maggio 2026 |
