...
| **Pannello di esperienza per CJA (Sollevamento e affidabilità generici)** | Questo nuovo pannello Workspace consente agli utenti di CJA di valutare l’incremento e l’affidabilità di qualsiasi esperimento A/B da qualsiasi sorgente (online, offline, dalle soluzioni Adobe, Adobe Journey Optimizer e persino dai dati BYO). Ulteriori informazioni da seguire. | 17 agosto 2022 |
