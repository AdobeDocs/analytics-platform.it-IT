...
| **Mappa connessione** | È disponibile una nuova interfaccia [mappa di connessione](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-connections/create-connection#connection-map) per visualizzare visivamente la configurazione della connessione. |  | 18 giugno 2025 |
