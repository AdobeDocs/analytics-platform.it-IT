...
| ----------- | ---------- | ------- | ---- |
| **Metriche del conteggio delle righe per i set di dati di ricerca e profilo** | In precedenza, queste metriche erano disponibili solo per i set di dati evento. | 16 ottobre 2023 |
