...
| **Ripeti generazione rapporti sessione** | Scopri se una particolare sessione è stata una sessione di ritorno dell’utente. [Ulteriori informazioni](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/data-views-usecases.html?lang=en#new-repeat) | 8 settembre 2022 |
