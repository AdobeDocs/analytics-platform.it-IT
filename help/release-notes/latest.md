...
| ----------- | ---------- | ------- | ---- |
| **Dimensione profondità evento** | Una nuova dimensione Profondità evento viene aggiunta all&#39;elenco di [componenti standard richiesti](/help/data-views/component-reference.md#required-standard-components) per una visualizzazione dati. |  | venerdì 8 maggio 2025 |
