...
| Nuovo [!UICONTROL Connections] Esperienza Info | Questo [!UICONTROL Connections] Il miglioramento dell’interfaccia utente ti consente di sapere se e quando i tuoi dati sono pronti per essere utilizzati nei rapporti. Permette inoltre di tenere traccia di eventuali problemi relativi all’elaborazione dei dati. [Ulteriori informazioni](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/manage-connections.html?lang=it) | 20 settembre 2021 |
