...
| API CUSTOMER JOURNEY ANALYTICS | 18 febbraio 2021 | Le API di Customer Journey Analytics sono ora disponibili. Queste API consentono di modificare i componenti a livello di programmazione e recuperare i rapporti. Per ulteriori informazioni, consulta la [documentazione dell&#39;API del Customer Journey Analytics](https://www.adobe.io/cja-apis/docs). |
