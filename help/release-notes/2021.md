...
| Tema scuro | Il [tema scuro](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-workspace/user-preferences.html#dark-theme) è disponibile come opzione di visualizzazione. | 21 ottobre 2021 |
...
| Funzione | Descrizione | [Disponibilità generale](https://experienceleague.adobe.com/docs/analytics/release-notes/releases.html?lang=it) - data di Target |
| ----------- | ---------- | ----- |
