...
| Eliminare una visualizzazione dati in [!UICONTROL Customer Journey Analytics] | Quando elimini una visualizzazione dati in Customer Journey Analytics, qualsiasi pannello in un progetto Workspace che si basa sulla visualizzazione dati non funziona più correttamente. |
