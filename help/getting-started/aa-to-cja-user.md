...
* [Report Builder](/help/report-builder/report-buider-overview.md) ha una nuova interfaccia e funziona su MS Windows, iOS e la versione web di Excel. (Prima di questa versione, non era possibile utilizzare Report Builder su Mac, se non tramite VMware.) Questa versione non supporta ancora la richiesta di dati AA tradizionale.
