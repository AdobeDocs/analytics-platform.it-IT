...
La pagina di destinazione del Customer Journey Analytics include una home page di project manager e una sezione di apprendimento per aiutarti a iniziare in modo più efficace.

>[!VIDEO](https://video.tv.adobe.com/v/334278/?quality=12)

## Accedere alla pagina di destinazione {#access-landing}

Dopo aver effettuato l&#39;accesso a Adobe Experience Cloud e al Customer Journey Analytics, abilita [!UICONTROL New landing page - Beta] pulsante di attivazione/disattivazione nell&#39;angolo in basso a sinistra. L’accesso al pulsante di attivazione/disattivazione è specifico per l’utente per organizzazione e non per azienda.

![Destinazione](assets/landing.png)

È possibile

* Espandi la [!UICONTROL Projects] da tabella a schermo intero. Per espandere la tabella, fai clic sull’icona del menu hamburger. Questa azione comprime le schede della barra a sinistra.
* Per personalizzare la larghezza della colonna, trascinate il separatore di colonna.
* Riordinare gli elementi bloccati. Per spostare gli elementi fissi verso l’alto o verso il basso, fai clic sui puntini di sospensione accanto all’elemento fissato e seleziona **[!UICONTROL Move up]** o **[!UICONTROL Move down]**.
...
| **[!UICONTROL Create new]** il modale è tornato | Quando fai clic su **[!UICONTROL Create new]** in Workspace, puoi nuovamente scegliere tra un [!UICONTROL Blank project] e [!UICONTROL Blank mobile scorecard]. Puoi anche scegliere tra tutti i modelli creati dalla tua azienda. |
