...
Customer Journey Analytics consente di controllare come collegare i dati online e offline in Analysis Workspace su qualsiasi ID cliente comune, consentendoti di eseguire attività di attribuzione, segmenti, flusso, abbandono ecc. tra i dati del cliente.
...
>[!TAB Pannelli di suddivisione]

Ora puoi suddividere un pannello in Analysis Workspace. Esistono scenari in cui si preferisce un raggruppamento di dati e visualizzazioni in un pannello prima di applicare segmenti a un pannello.

[![immagine](assets/learn-more-button.svg)](/help/analysis-workspace/c-panels/panels.md#break-down-a-panel)
...
>[!TAB Unione nelle connessioni]

Ora puoi configurare e abilitare l’unione sui set di dati dell’evento direttamente nell’interfaccia utente delle connessioni di Customer Journey Analytics.
...
L’analisi del pubblico consente di acquisire i dati sull’iscrizione del pubblico dai set di dati del profilo di Experience Platform in una connessione Customer Journey Analytics.

[![immagine](assets/learn-more-button.svg)](/help/connections/audience-analysis/analyze-audiences.md)
...
<b>Resta informato, contribuisce alla community e migliora la tua esperienza con Customer Journey Analytics.</b><br>Visita la community di Adobe Analytics per discutere di queste funzionalità con altri professionisti. <a href="https://experienceleaguecommunities.adobe.com/t5/adobe-analytics/ct-p/adobe-analytics-community">Iscriviti alla community oggi stesso!</a></td></tr></tbody></table>
