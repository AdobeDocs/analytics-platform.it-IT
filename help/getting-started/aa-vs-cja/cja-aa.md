...
description: Scopri le funzioni di Customer Journey Analytics rispetto alle funzioni di Adobe Analytics.
...
| **B2B Edition** | [Customer Journey Analytics B2B edition](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition?lang=en) consente alle aziende B2B di allineare i team di marketing, vendita e prodotto fornendo informazioni utili che guidano la crescita dei ricavi. Collocando l’account al centro del modello dati, tutte le analisi si concentrano sul suo percorso. L’aggiunta di un nuovo livello di entità (account, opportunità e gruppi acquisti), oltre a eventi basati su persona e tempo, crea un quadro completo del ciclo di vita di marketing e ricavi B2B. |
| **Estensione BI** | L&#39;estensione [BI](https://experienceleague.adobe.com/it/docs/analytics-platform/using/cja-usecases/data-export/bi-extension) consente di connettere Customer Journey Analytics direttamente ai più comuni strumenti di visualizzazione di BI, come Power BI o Tableau. Utilizzando questa estensione, puoi far corrispondere esattamente i rapporti BI a quelli visualizzati in Analysis Workspace e in altre interfacce di reporting di Customer Journey Analytics. Questa estensione offre un modo molto più semplice per ottenere rapporti BI per Customer Journey Analytics senza la necessità di ricreare rapporti/metriche dai dati non elaborati. |
...
| **Rilevamento bot** | [Supporto completo](https://experienceleague.adobe.com/en/docs/experience-platform/datastreams/bot-detection) |
...
| **eVar di merchandising** | Supporto completo tramite [dimensioni e metriche di binding](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-dataviews/component-settings/persistence) |
...
| **Conversione valuta** | Supportata come parte della [formattazione di un componente metrico](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-dataviews/component-settings/format) in una visualizzazione dati. |
...
| **Dimensioni di segmentazione geografica** | [Supporto completo](https://experienceleague.adobe.com/en/docs/experience-platform/datastreams/configure) |
