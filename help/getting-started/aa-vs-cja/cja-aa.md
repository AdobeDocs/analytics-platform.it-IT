...
| Variabile dei prodotti | Nell’Experience Platform, per soddisfare questo caso d’uso, gli utenti possono utilizzare un array di oggetti all’interno di uno schema di set di dati. All’interno di Customer Journey Analytics, i clienti possono utilizzare un qualsiasi numero di variabili di prodotto e non sono limitati a una singola variabile, come accade invece in Adobe Analytics. |
