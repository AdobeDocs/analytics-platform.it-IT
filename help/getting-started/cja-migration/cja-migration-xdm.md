...
Non tutti i metodi di migrazione richiedono di mappare i dati di Adobe Analytics sullo schema XDM. La tabella seguente mostra quali metodi di implementazione richiedono la mappatura dello schema XDM:
