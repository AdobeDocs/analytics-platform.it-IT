...
1. Nell&#39;interfaccia utente di Platform, nella sezione **[!UICONTROL Connessioni]** della barra a sinistra, seleziona **[!UICONTROL Origini]**.

1. Seleziona **[!UICONTROL applicazioni Adobe]** dall&#39;elenco di [!UICONTROL CATEGORIE].

1. Seleziona **[!UICONTROL Aggiungi dati]** nel riquadro Adobe Analytics.
...
1. Seleziona **[!UICONTROL Suite di rapporti]**, quindi dall&#39;elenco delle suite di rapporti seleziona la suite di rapporti che contiene i dati storici che desideri utilizzare in Customer Journey Analytics.

   ![Finestra di Adobe Experience Platform con l’elenco delle suite di rapporti](./assets/report-suites.png)

1. Seleziona **[!UICONTROL Avanti]** nell&#39;angolo superiore destro dello schermo.

1. Seleziona **[!UICONTROL Schema personalizzato]**, quindi seleziona lo schema creato in [Creare uno schema personalizzato che includa il gruppo di campi di Adobe Analytics](/help/getting-started/cja-upgrade/cja-upgrade-source-connector-schema.md). <!-- Deleted this, because I changed this from choosing the default schemawe're pointing them now at the schema they just created: "Adobe Experience Platform  automatically creates the schema and the corresponding dataset to map all standard fields from the selected Adobe Analytics report suite." -->
...
1. Mappa ogni dimensione di Adobe Analytics a una dimensione dello schema personalizzata.
   ...
   1. Nel campo **[!UICONTROL Source]**, seleziona un campo Adobe Analytics dal gruppo di campi Modello Adobe Analytics ExperienceEvent. Quindi, nel **[!UICONTROL campo di destinazione]**, seleziona il campo personalizzato nello schema XDM a cui vuoi mapparlo.
...
1. Rivedi la connessione, quindi seleziona **[!UICONTROL Fine]**.
