...
Diversi fattori possono influenzare le prestazioni complessive di CJA, nonché le prestazioni di un progetto in Analysis Workspace. In Workspace, potrebbe venire visualizzato un messaggio di errore che indica che il rapporto è troppo complesso. [È questa la formulazione esatta del messaggio?] In questo argomento vengono illustrati i fattori che possono causare l&#39;errore e la procedura per semplificare il report o il progetto.

## Prestazioni complessive di CJA
