...
* **Accesso contrattuale**: il contratto di vendita Adobe deve includere una clausola che consenta ad Adobe di utilizzare i dati nello sviluppo di modelli AI/ML (clausola 6.2).
