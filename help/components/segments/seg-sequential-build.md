...
Identifica le persone che hanno visualizzato una pagina in una sessione e poi un’altra pagina in un’altra sessione. Per distinguere le sessioni, utilizza i contenitori per generare la sequenza e definire il livello ![Visita](/help/assets/icons/Visit.svg) **[!UICONTROL Sessione]** per ogni contenitore.

![Segmento di sequenza tra sessioni](assets/sequence-filter-session.png)

#### Sequenza a livello misto

Identifica le persone che visualizzano due pagine in un numero indeterminato di sessioni e quindi visualizzano una terza pagina in una sessione separata. Utilizza di nuovo i contenitori per generare la sequenza e definire il livello ![Visita](/help/assets/icons/Visit.svg) **[!UICONTROL Sessione]** nel contenitore che definisce la sessione separata.
...
## [!UICONTROL Dopo] e [!UICONTROL Entro]

È possibile utilizzare ![Orologio](/help/assets/icons/Clock.svg) **[!UICONTROL Dopo]** e ![Orologio](/help/assets/icons/Clock.svg) **[!UICONTROL Entro]** l&#39;operatore **[!UICONTROL Then]** per definire ulteriori [vincoli di tempo](#time-constraints) o [vincoli per eventi, sessioni o dimensioni](#event-session-and-dimension-constraints).
...
##### [!UICONTROL Operatore After] but [!UICONTROL Within]
...
I vincoli ![Orologio](/help/assets/icons/Clock.svg) **[!UICONTROL Dopo]** e ![Orologio](/help/assets/icons/Clock.svg) **[!UICONTROL Entro]** consentono di specificare non solo un vincolo di tempo, ma anche un vincolo di evento, sessione o dimensione. Seleziona **[!UICONTROL Eventi]**, **[!UICONTROL Sessioni]** o **[!UICONTROL Altre dimensioni]** ![ChevronRight](/help/assets/icons/ChevronRight.svg) **[!UICONTROL *Nome Dimension *]**. Puoi usare il campo [!UICONTROL *Ricerca*] per cercare una dimensione.
...
### [!UICONTROL Tutti] {#include_everyone}
...
### [!UICONTROL Solo prima della sequenza] e [!UICONTROL Solo dopo la sequenza]
...
Hai definito tre versioni di un segmento sequenziale per le sezioni del sito. Uno con l&#39;opzione ![GruppoUtenti](/help/assets/icons/UserGroup.svg) **[!UICONTROL Includi tutti]**, uno con l&#39;opzione ![SequenzaPrima](/help/assets/icons/SequenceBefore.svg) **[!UICONTROL Solo prima della sequenza]** e uno con l&#39;opzione ![SequenzaDopo](/help/assets/icons/SequenceAfter.svg) **[!UICONTROL Solo dopo la sequenza]**. Hai assegnato ai tre segmenti il nome desiderato.
...
Le definizioni dei segmenti includono tutti i dati a meno che tu non escluda espressamente ![Utente](/help/assets/icons/User.svg) [!UICONTROL Persona], ![Visita](/help/assets/icons/Visit.svg) [!UICONTROL Sessione] o ![Pagina Web](/help/assets/icons/WebPage.svg) [!UICONTROL Evento] dati utilizzando **[!UICONTROL Escludi]**.

[!UICONTROL Escludi] ti consente di ignorare i dati comuni e creare segmenti con maggiore attenzione. Escludi consente inoltre di creare segmenti escludendo gruppi specifici di persone. Ad esempio, per definire un segmento che specifica le persone che hanno effettuato gli ordini e poi escludendo quel gruppo di persone per identificare *i non acquirenti*. Una procedura consigliata consiste nel creare regole che utilizzano una definizione ampia anziché tentare di utilizzare [!UICONTROL Escludi] per eseguire il targeting di un utente tipo specifico che corrisponde a specifici valori di inclusione.
...
* **Identifica i non acquirenti**. Identifica quando gli ordini sono maggiori di zero e quindi esclude la [!UICONTROL persona].

[!UICONTROL Escludi] può essere utilizzato per identificare una sequenza in cui le persone non fanno parte di sessioni specifiche o eseguono eventi specifici. [!UICONTROL Escludi] può essere incluso anche in un [!UICONTROL Gruppo logico] (vedi sotto).

Puoi escludere i contenitori, non i componenti.

### Esempi

Di seguito sono riportati alcuni esempi di utilizzo di [!UICONTROL Escludi].

#### [!UICONTROL Escludi] entro

Identifica le persone che hanno visitato una pagina, non hanno visitato un’altra pagina e poi hanno visitato un’altra pagina. Escludi il contenitore utilizzando ![Impostazione](/help/assets/icons/Setting.svg) [!UICONTROL Escludi]. Un contenitore escluso è identificato da una sottile barra rossa a sinistra.

![Escludi sequenza](assets/sequence-exclude.png)


#### [!UICONTROL Escludi] all&#39;inizio
...
## [!UICONTROL Gruppo logico]

>[!NOTE]
>
>Un [!UICONTROL Gruppo logico] può essere definito solo in un segmento sequenziale, il che significa che l&#39;operatore [!UICONTROL Then] viene utilizzato all&#39;interno del contenitore.
...
[!UICONTROL Gruppo logico] è stato progettato per trattare *diverse condizioni come un gruppo, senza alcun ordine* tra le condizioni raggruppate. In caso contrario, l’ordine delle condizioni all’interno di un Gruppo logico è irrilevante.
