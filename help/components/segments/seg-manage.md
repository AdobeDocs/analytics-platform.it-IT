...
Puoi [condividere](seg-share.md), [segmento](seg-filter.md), [tag](seg-tag.md), [approvare](seg-approve.md), rinominare, [copiare](seg-copy.md), eliminare, esportare segmenti e contrassegnarli come [preferiti](seg-favorite.md) da un&#39;interfaccia di gestione [!UICONTROL Segmento] centrale. Per gestire i segmenti:

* Seleziona **[!UICONTROL Componenti]** nell&#39;interfaccia principale, quindi seleziona **[!UICONTROL Segmenti]**.
...
| Azione | Descrizione |
|---|---|
| ![AggiungiCerchio](/help/assets/icons/AddCircle.svg) **[!UICONTROL Aggiungi]** | Aggiungi un altro segmento utilizzando il [Generatore di segmenti](seg-builder.md). |
