...
1. Nella finestra di dialogo **[!UICONTROL Segmenti tag]**:
...
1. Seleziona **[!UICONTROL Salva]** per salvare i tag per il segmento. Seleziona **[!UICONTROL Annulla]** per annullare.
