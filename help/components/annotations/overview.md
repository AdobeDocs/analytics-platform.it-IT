...
Ad esempio, supponiamo che tu condivida dei progetti con la tua organizzazione. Se si è verificato un picco importante nel traffico a causa di una campagna di marketing, è possibile creare un’annotazione &quot;Data di lancio della campagna&quot; e impostarla come ambito per l’intera visualizzazione dei dati. Quando gli utenti visualizzano qualsiasi set di dati che includeva tale data, visualizzano l’annotazione all’interno dei loro progetti, insieme ai relativi dati.
...
* Possono essere applicati alla visualizzazione dati in cui sono stati creati (impostazione predefinita) o a tutte le visualizzazioni dati.
