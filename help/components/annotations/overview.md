...
| Livello | Procedura |
|---|---|
| **Visualizzazione** | Abilita o disabilita ![Impostazione](/help/assets/icons/Setting.svg) > **[!UICONTROL Impostazioni]** > **[!UICONTROL Mostra annotazioni]**.<br/>![Abilitare o disabilitare annotazioni per una visualizzazione](/help/components/annotations/assets/annotations-visualization.png) |
| **Progetto** | Dal menu di un progetto di Workspace, seleziona **[!UICONTROL Progetto]** > **[!UICONTROL Informazioni e impostazioni progetto]** e abilita o disabilita **[!UICONTROL Mostra annotazioni]**.<br/>![Abilitare o disabilitare annotazioni per un progetto](/help/components/annotations/assets/annotations-project.png) |
| **Utente** | Dalla scheda **[!UICONTROL Componenti]**, seleziona **[!UICONTROL Preferenze]** oppure dal menu di un progetto Workspace, seleziona **[!UICONTROL Progetto]** > **[!UICONTROL Preferenze utente]**. <br/>In **[!UICONTROL Preferenze]**, seleziona **[!UICONTROL Progetti e analisi]**. Dalla barra della scheda a sinistra, seleziona **[!UICONTROL Dati]**. In basso, abilita o disabilita **[!UICONTROL Mostra annotazioni]** sotto l&#39;intestazione **[!UICONTROL Tabella a forma libera]**.<br/>![Abilitare o disabilitare annotazioni per un utente](/help/components/annotations/assets/annotations-user.png) |
