...
Dopo aver esportato una tabella completa come descritto in [Esporta dati di Customer Journey Analytics nel cloud](/help/analysis-workspace/export/export-cloud.md), le esportazioni sono disponibili sul [!UICONTROL Exports] scheda della [!UICONTROL Exports] pagina.
...
1. Seleziona la **Personalizza tabella** icona ![personalizza tabella](assets/customize-table-icon.png) in alto a destra nella [!UICONTROL Exports] pagina.
   ...
   |---------|----------|
   | Nome | Nome dell’esportazione. Gli utenti assegnano un nome alle esportazioni quando le creano, come descritto in [Esporta dati di Customer Journey Analytics nel cloud](/help/analysis-workspace/export/export-cloud.md). |
