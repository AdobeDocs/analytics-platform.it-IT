...
1. Dal menu di scelta rapida o dal pulsante ![AltreVerticali](/help/assets/icons/MoreVertical.svg) azioni del componente (nella parte superiore di Componenti), selezionare una delle azioni seguenti.
   ...
   | ![Condividi](/help/assets/icons/Share.svg) [!UICONTROL **Condividi**] | Condividi i componenti con gli utenti della tua organizzazione. Questa opzione è disponibile solo per i componenti personalizzati, ad esempio filtri o metriche calcolate. |
