...
I tipi di pubblico possono essere gestiti in Customer Journey Analytics utilizzando **[!UICONTROL Componenti]** > **[!UICONTROL Tipi di pubblico]**.
...
1. In Customer Journey Analytics, seleziona **[!UICONTROL Componenti]** > **[!UICONTROL Pubblico pubblicato]**.
...
1. Cerca un pubblico utilizzando ![Ricerca](/help/assets/icons/Search.svg) (facoltativo).
   ...
   | **[!UICONTROL Titolo e descrizione]** | Il titolo e la descrizione inseriti durante la creazione del tipo di pubblico. |
   | **[!UICONTROL Visualizzazione dati]** | La visualizzazione dati in cui è stato creato il pubblico. |
   | **[!UICONTROL Dimensione del pubblico]** | Il numero totale di persone nel pubblico. |
   | **[!UICONTROL Proprietario]** | Il proprietario del tipo di pubblico, ovvero la persona che lo ha creato. |
   | **[!UICONTROL Frequenza di aggiornamento]** | L’intervallo di aggiornamento configurato al momento della creazione del tipo di pubblico. |
   | **[!UICONTROL Tag]** | Eventuali tag applicati a questo pubblico. |
   | **[!UICONTROL Stato pubblicazione]** | Può mostrare ![StatusGreen](/help/assets/icons/StatusGreen.svg) **[!UICONTROL Pronto]**, ![StatusGray](/help/assets/icons/StatusGray.svg) **[!UICONTROL In corso]**, o ![StatusRed](/help/assets/icons/StatusRed.svg) **[!UICONTROL Errore]**. |
   | **[!UICONTROL Ultimo aggiornamento]** | La marca temporale dell’ultimo aggiornamento effettuato al tipo di pubblico. |
   | **[!UICONTROL Ultima modifica]** | La marca temporale dell’ultima modifica apportata al tipo pubblico. |
...
1. Seleziona il titolo del pubblico da modificare.
   ...
   Viene visualizzata la finestra di dialogo **[!UICONTROL Modifica pubblico]**.
...
| ![Elimina](/help/assets/icons/Delete.svg) | **[!UICONTROL Elimina]** | Elimina i tipi di pubblico selezionati. |
| ![FileCSV](/help/assets/icons/FileCSV.svg) | **[!UICONTROL Esporta in CSV]** | Esporta i tipi di pubblico selezionati in un file denominato `audiences.csv`. |
