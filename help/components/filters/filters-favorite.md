...
Per favorire o sfavorire un segmento, nel [Gestore segmenti](/help/components/filters/manage-filters.md):
...
Puoi ordinare l’elenco dei segmenti in base ai preferiti. Selezionare **[!UICONTROL Other segments]** dal pannello ![Segmento](/help/assets/icons/Filter.svg) **[!UICONTROL Segment]** e selezionare **[!UICONTROL Favorites]**. Per ulteriori informazioni, consulta [Segmentare l&#39;elenco dei segmenti](/help/components/filters/filters-filter.md).
