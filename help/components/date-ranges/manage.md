...
* **Aggiungi**: Crea un nuovo intervallo di date. Per ulteriori informazioni, vedere [creare un intervallo di date](create.md).
...
* **Preferiti**: Fai clic sull’icona  ![](../assets/star.png) accanto a un intervallo di date per aggiungerlo ai preferiti.
* **Personalizzare le colonne**: Fare clic sulla  ![](../assets/columns.png) colonna per mostrare o nascondere le colonne nel gestore intervalli di date.
