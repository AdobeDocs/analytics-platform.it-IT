...
* **Tracciare i punteggi di tendenza di un segmento di utenti nel tempo**. Caso d’uso di esempio: qual è la probabilità che un cliente acquisti un biglietto per lo spettacolo presso la sala concerti dell’hotel?
...
* **Seguire il flusso di entrata della tendenza del cliente su diverse esecuzioni di punteggio**. Caso d’uso di esempio: vorrei capire di più sulle persone che inizialmente erano utenti a bassa tendenza e, nel tempo, sono diventate utenti a tendenza elevata.
