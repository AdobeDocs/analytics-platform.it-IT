...
description: Abilita l’unione per i set di dati evento in Customer Journey Analytics. Configura gli ID persistenti, gli ID persona e le finestre di ripetizione nell’interfaccia utente Connessioni.
...
1. Selezionare un ID persistente dal menu a discesa **[!UICONTROL ID persistente]**.
   ...
   Se si seleziona **[!UICONTROL Mappa identità]** per l&#39;ID persistente, selezionare uno spazio dei nomi. Sono disponibili due opzioni:
...
1. Selezionare un ID persona dal menu a discesa **[!UICONTROL ID persona]**.
   ...
   Se si seleziona **[!UICONTROL Mappa identità]** per l&#39;ID persona, selezionare uno spazio dei nomi. Sono disponibili due opzioni:
...
>[!AVAILABILITY]
>
>Le metriche di unione non sono disponibili per l’unione basata su grafico.
>
...
>[!AVAILABILITY]
>
>Gli ID non validi non sono disponibili per l’unione basata su grafico.
>
