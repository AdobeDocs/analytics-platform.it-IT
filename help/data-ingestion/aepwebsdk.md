---
title: Inserire dati tramite SDK per Web di Adobe Experience Platform e la rete Edge
...
>[!NOTE]
>
>Questa è una guida semplificata su come inserire i dati raccolti dal sito in Adobe Experience Platform e utilizzarli in Customer Journey Analytics. Ti consigliamo vivamente di esaminare le informazioni aggiuntive quando vi fai riferimento.
...
Aggiungi l’estensione Adobe Platform Web SDK al tag per assicurarti di poter inviare dati ad Adobe Experience Platform (tramite il flusso di dati).
...
Questo è solo un esempio di definizione di una regola che invia dati XDM, contenenti valori da altri elementi di dati, ad Adobe Experience Platform.
