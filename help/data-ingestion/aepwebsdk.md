...
L’SDK per web include [!UICONTROL Adobe Experience Cloud ID Service] in modalità nativa, quindi non è necessario aggiungere l’estensione del servizio ID al tag.
