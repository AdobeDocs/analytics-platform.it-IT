...
>[!NOTE]
>
>Questa è una guida semplificata su come acquisire i dati utilizzando un connettore di origine in Adobe Experience Platform e utilizzarli nel Customer Journey Analytics.  Si raccomanda vivamente di studiare le informazioni aggiuntive quando si fa riferimento a tali informazioni.
...
2. Seleziona il connettore sorgente dall’elenco dei connettori sorgente disponibili. Ogni connettore segue un flusso di lavoro simile:
   ...
   - **[!UICONTROL Dataflow detai]**: Fornisci ulteriori dettagli sul flusso di dati, ad esempio il nome e il set di dati da utilizzare.
   ...
   - **[!UICONTROL Review]**: Prima di terminare la configurazione, esaminerai la definizione del connettore di origine.
