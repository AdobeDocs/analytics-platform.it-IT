...
>title="Cambiare le impostazioni di identità "
>abstract="Se si cambia l’impostazione dell’identità, una volta salvate le modifiche nell’interfaccia Connessioni verranno eliminati i dati di connessione per questo set di dati. Sarà quindi necessario avviare manualmente una retrocompilazione dei dati per il set di dati in base alle nuove impostazioni.<br/><br/>È possibile che si verifichi un ritardo nei report fino al completamento del processo di eliminazione."
...
>abstract="Rileva e utilizza automaticamente uno spazio dei nomi identityMap definito come **[!UICONTROL primario]**, a ciascun livello di evento."
>additional-url="https://experienceleague.adobe.com/it/docs/experience-platform/identity/features/namespaces" text="Panoramica sullo spazio dei nomi delle identità"
...
>abstract="Questa opzione consente di sfruttare le funzionalità di reporting avanzate di Customer Journey Analytics con la connessione Journey Optimizer. Queste funzionalità consentono di:<ul><li>Eseguire un’analisi approfondita dei dati di Journey Optimizer all’interno di Customer Journey Analytics.</li><li>Modificare la connessione Journey Optimizer e le visualizzazioni dati associate.</li><li>Analizzare gli eventi del percorso, i percorsi della conversazione e le prestazioni della campagna.</li></ul>**Attivando questa opzione, ciascuna riga di dati all’interno della connessione verrà conteggiata ogni mese nella licenza di Customer Journey Analytics. E sarà riportata nell’interfaccia utente di Utilizzo connessioni.**<br><br/> Esplora questa opzione solo se hai dimestichezza con l’utilizzo di ulteriori righe di dati in Customer Journey Analytics. [Ulteriori informazioni](https://experienceleague.adobe.com/it/docs/analytics-platform/using/integrations/ajo){target="_blank"}."

>[!CONTEXTUALHELP]
>id="connections_disableuseincja_exl_ajo"
>title="Rimuovere questa connessione da Customer Journey Analytics"
>abstract="Questa connessione di Journey Optimizer è attualmente utilizzata in Customer Journey Analytics. La connessione consente di:<ul><li>Eseguire un’analisi approfondita dei dati di Journey Optimizer all’interno di Customer Journey Analytics.</li><li>Modificare la connessione Journey Optimizer e le visualizzazioni dati associate.</li><li>Analizzare gli eventi del percorso, i percorsi della conversazione e le prestazioni della campagna.</li></ul>**Se rimuovi la connessione, non sarà più possibile eseguire analisi approfondite in Customer Journey Analytics. La connessione ed eventuali visualizzazioni dati associate vengono ripristinate allo stato predefinito e non possono più essere modificate.**<br/><br/>**La fatturazione per questa connessione in Customer Journey Analytics include l’intero mese durante il quale la connessione viene rimossa.**<br/><br/> La connessione rimane abilitata in Journey Optimizer. [Ulteriori informazioni](https://experienceleague.adobe.com/it/docs/analytics-platform/using/integrations/ajo){target="_blank"}."

>[!CONTEXTUALHELP]
>id="connections_useincja_exl_brand_concierge"
>title="Utilizza questa connessione in Customer Journey Analytics"
>abstract="Questa opzione ti consente di sfruttare le funzionalità di reporting avanzate di Customer Journey Analytics con la connessione a Brand Concierge. Queste funzionalità consentono di:<ul><li>Eseguire un’analisi approfondita dei dati di Brand Concierge all’interno di Customer Journey Analytics.</li><li>Modificare la connessione di Brand Concierge e le visualizzazioni dati associate.</li><li>Analizzare il coinvolgimento conversazionale, il sentiment e le metriche di conversione.</li></ul>**Attivando questa opzione, ciascuna riga di dati all’interno della connessione verrà conteggiata ogni mese nella licenza di Customer Journey Analytics. E sarà riportata nell’interfaccia utente di Utilizzo connessioni.**<br><br/> Esplora questa opzione solo se hai dimestichezza con l’utilizzo di ulteriori righe di dati in Customer Journey Analytics. [Ulteriori informazioni](https://experienceleague.adobe.com/it/docs/analytics-platform/using/cja-workspace/templates/use-templates#brand-concierge-templates){target="_blank"}."

>[!CONTEXTUALHELP]
>id="connections_disableuseincja_exl_brand_concierge"
>title="Rimuovere questa connessione da Customer Journey Analytics"
>abstract="Questa connessione Brand Concierge è attualmente utilizzata in Customer Journey Analyics. La connessione consente di:<ul><li>Eseguire un’analisi approfondita dei dati di Brand Concierge all’interno di Customer Journey Analytics.</li><li>Modificare la connessione di Brand Concierge e le visualizzazioni dati associate.</li><li>Analizzare il coinvolgimento conversazionale, il sentiment e le metriche di conversione.</li></ul>**Se rimuovi la connessione, non sarà più possibile effettuare analisi approfondite in Customer Journey Analytics. La connessione ed eventuali visualizzazioni dati associate vengono ripristinate allo stato predefinito e non possono più essere modificate.**<br/><br/>**La fatturazione per questa connessione in Customer Journey Analytics include l’intero mese durante il quale la connessione viene rimossa.**<br/><br/> La connessione rimane abilitata in Brand Concierge. [Ulteriori informazioni](https://experienceleague.adobe.com/it/docs/analytics-platform/using/cja-workspace/templates/use-templates#brand-concierge-templates){target="_blank"}."

>[!CONTEXTUALHELP]
>id="connections_useincja_exl_product_usage"
>title="Utilizza questa connessione in Customer Journey Analytics"
>abstract="Questa opzione ti consente di sfruttare le funzionalità di reporting avanzate di Customer Journey Analytics con la connessione di utilizzo del prodotto. Queste funzionalità consentono di:<ul><li>Esegui un’analisi approfondita dei dati di di utilizzo del prodotto all’interno di Customer Journey Analytics.</li><li>Modificare la connessione di utilizzo del prodotto e le visualizzazioni dati associate.</li></ul>**Attivando questa opzione, ciascuna riga di dati all’interno della connessione verrà conteggiata ogni mese nella licenza di Customer Journey Analytics. E sarà riportata nell’interfaccia utente di Utilizzo connessioni.**<br><br/> Esplora questa opzione solo se hai dimestichezza con l’utilizzo di ulteriori righe di dati in Customer Journey Analytics. [Ulteriori informazioni](https://experienceleague.adobe.com/it/docs/analytics-platform/using/tools/product-usage/usage-overview){target="_blank"}."

>[!CONTEXTUALHELP]
>id="connections_disableuseincja_exl_product_usage"
>title="Rimuovere questa connessione da Customer Journey Analytics"
>abstract="Questa connessione di utilizzo del prodotto è attualmente utilizzata in Customer Journey Analytics. La connessione consente di:<ul><li>Esegui un’analisi approfondita dei dati di di utilizzo del prodotto all’interno di Customer Journey Analytics.</li><li>Modifica la connessione di utilizzo del prodotto e le visualizzazioni dati associate.</li></ul>**Se rimuovi la connessione, non sarà più possibile eseguire analisi approfondite in Customer Journey Analytics. La connessione ed eventuali visualizzazioni dati associate vengono ripristinate allo stato predefinito e non possono più essere modificate.**<br/><br/>**La fatturazione per questa connessione in Customer Journey Analytics include l’intero mese durante il quale la connessione viene rimossa.**<br/><br/> La connessione rimane abilitata per l’utilizzo del prodotto. [Ulteriori informazioni](https://experienceleague.adobe.com/it/docs/analytics-platform/using/tools/product-usage/usage-overview){target="_blank"}."
...
>abstract="Seleziona contenitori aggiuntivi.<br/><br/>**[!UICONTROL Account globale ]**: consente la configurazione di account globali in una connessione.<br/>**[!UICONTROL Opportunità]**: consente la configurazione di opportunità in una connessione.<br/>**[!UICONTROL Gruppo acquisti ]**: abilita la configurazione dei gruppi di acquisto in una connessione."
...
>abstract="Seleziona un campo di tipo identità o identityMap disponibile su tutti gli eventi, ad esempio il campo contenente gli ECID. Questi identificatori saranno elevati agli ID persona dello spazio dei nomi dell’identificatore della persona configurato in precedenza."

>[!CONTEXTUALHELP]
>id="connection_b2bstitching_accountid"
>title="ID account"
>abstract="Facoltativamente, seleziona un ID account dai campi di identità non di persona o non di identità disponibili definiti nello schema XDM. I valori contenuti verranno utilizzati come identificatore univoco dell’account a livello di riga, ogni volta che le informazioni sull’ID account correlate non sono disponibili nel set di dati da persona ad account."
...
>title="Unione delle identità"
>abstract="L’unione delle identità ricava le informazioni sull’identità utente da un set di dati o dal grafo di identità. Questo processo può includere l’unione di dati utente provenienti da sessioni autenticate e non autenticate.<br/><br/>L’utente è responsabile del rispetto delle leggi e delle normative applicabili. Nell’ambito di tali requisiti di conformità, prima di attivare l’unione delle identità su un set di dati dovrai ottenere le necessarie autorizzazioni degli utenti finali."
>additional-url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/stitching/overview" text="Panoramica sull’unione delle identità"
...
>abstract="Seleziona lo spazio dei nomi da utilizzare per scegliere l’identificatore dal grafo di identità."
>additional-url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/stitching/overview" text="Panoramica sull’unione delle identità"
...
| **[!UICONTROL Ricerca]** | Ora puoi aggiungere set di dati come ricerche di campi all’interno di tutti i tipi di set di dati: Profilo, Ricerca ed Evento (l’ultimo è sempre stato supportato). Questa funzionalità aggiuntiva estende la capacità di Customer Journey Analytics di supportare modelli di dati complessi, tra cui B2B. Questi dati vengono utilizzati per cercare i valori o le chiavi presenti nei dati Evento, Profilo o Ricerca. Puoi aggiungere fino a tre livelli di ricerca. Ad esempio, puoi caricare dati ricerca per mappare gli ID numerici presenti nei dati evento sui nomi dei prodotti. Per un esempio, consulta l’[esempio B2B](/help/use-cases/b2b/example.md). <br/><br/>**Nota**: <ul><li>[I campi derivati](/help/data-views/derived-fields/derived-fields.md) non possono essere utilizzati come chiavi corrispondenti per le ricerche nelle connessioni.</li><li>Le ricerche di grandi dimensioni non sono supportate per [Chiavi gestite dal cliente](/help/privacy/cmk.md) e [Set di dati ad hoc](#ad-hoc-dataset).</li></ul> | N/D | Qualsiasi schema incorporato o personalizzato basato su una classe XDM con comportamento *Record*, ad eccezione della classe *Profilo individuale XDM*. | N/D |
...
1. Configura le [impostazioni per ciascuno dei set di dati selezionati](#dataset-settings), uno alla volta, nel passaggio ➋ **[!UICONTROL Impostazioni set di dati]** della finestra di dialogo **[!UICONTROL Aggiungi set di dati]**.
   ...
   * Per rimuovere un set di dati dalla connessione, selezionare ![RimuoviCerchio](/help/assets/icons/RemoveCircle.svg) **[!UICONTROL Rimuovi]**.
   * Per fare un passo indietro, selezionare **[!UICONTROL Indietro]**.
   * Per annullare l&#39;aggiunta di set di dati a una connessione, selezionare **[!UICONTROL Annulla]**.

1. Prima di continuare, è necessario specificare tutte le impostazioni richieste per i set di dati selezionati. Se manca l’input richiesto, viene visualizzato un numero rosso che indica quanti set di dati di un tipo specifico mancano dell’input richiesto. Un ![AlertRed](/help/assets/icons/AlertRed.svg) e una spiegazione in rosso identificano i campi obbligatori che non hanno un input o un valore selezionato. Dopo aver configurato tutte le impostazioni richieste per tutti i set di dati, seleziona **[!UICONTROL Avanti]**.
1. In ❸ **[!UICONTROL Anteprima set di dati]** viene visualizzata un&#39;anteprima per ogni set di dati basata su un semplice set di dati da dati acquisiti di recente.

   ![Anteprima di un set di dati durante l&#39;aggiunta di set di dati come parte di una connessione](/help/connections/assets/add-dataset-preview.png)
...
1. Seleziona **[!UICONTROL Aggiungi set di dati]** per aggiungere i set di dati configurati alla connessione.



#### Per connessioni basate su account
...
1. Configura le [impostazioni per ciascuno dei set di dati selezionati](#dataset-settings), uno alla volta, nel passaggio ➋ **[!UICONTROL Impostazioni set di dati]** della finestra di dialogo **[!UICONTROL Aggiungi set di dati]**.
   ...
   ![Aggiungere set di dati](assets/add-dataset-b2b.png)
...
1. In ❶ **[!UICONTROL Impostazioni set di dati]**, configurare le [impostazioni set di dati](#dataset-settings) nella finestra di dialogo **[!UICONTROL Modifica set di dati: _Nome set di dati_]**.

   ![Modifica set di dati](assets/edit-dataset-b2c.png)

   Se apporti modifiche, assicurati di specificare tutte le impostazioni richieste per il set di dati prima di continuare. Se manca l’input richiesto, non puoi continuare. Un ![AlertRed](/help/assets/icons/AlertRed.svg) e una spiegazione in rosso identificano i campi obbligatori che non hanno un input o un valore selezionato.
   ...
   Per rimuovere il set di dati dalla connessione, selezionare ![RimuoviCerchio](/help/assets/icons/RemoveCircle.svg) **[!UICONTROL Rimuovi]**.

   Dopo aver configurato tutte le impostazioni richieste per il set di dati, seleziona **[!UICONTROL Avanti]**.
...
1. Configura le [impostazioni del set di dati](#dataset-settings) nella finestra di dialogo **[!UICONTROL Modifica set di dati: _Nome del set di dati_]**.
   ...
   ![Modifica set di dati](assets/edit-dataset-b2b.png)
...
Questa mappa consente di comprendere meglio come è stata definita la connessione. E come hai impostato la relazione tra i set di dati evento, profilo, ricerca e riepilogo, utilizzando contenitori e identificatori.
