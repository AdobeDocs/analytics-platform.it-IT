...
>abstract="L’utilizzo di Customer Journey Analytics può comportare modifiche aggiuntive in base ai volumi di dati di integrazione. Vedi [dettagli su fatturazione e utilizzo di Customer Journey Analytics](https://experienceleague.adobe.com/it/docs/analytics-platform/using/cja-connections/manage-connections#connections-usage)"
