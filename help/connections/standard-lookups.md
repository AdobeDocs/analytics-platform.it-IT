...
>[!IMPORTANT]
>Le ricerche standard sono disponibili solo per le origini dati del Connettore dati di Analytics in CJA. Puoi utilizzarli con le implementazioni standard di Adobe Analytics, [Adobe Experience Platform Web SDK](https://experienceleague.adobe.com/docs/experience-platform/edge/home.html?lang=it) o le API di raccolta dati di Experience Platform.
