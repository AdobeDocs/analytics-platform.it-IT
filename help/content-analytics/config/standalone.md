...
description: Guida dettagliata alla configurazione di Adobe Content Analytics come soluzione autonoma. Scopri come impostare schemi, set di dati, flussi di dati e rapporti per ottenere informazioni complete sulle prestazioni dei contenuti senza una completa implementazione di Customer Journey Analytics.
...
Vedi ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Gestire gli utenti per un profilo di prodotto](https://experienceleague.adobe.com/it/docs/experience-platform/access-control/ui/users){target="_blank"} per un video dimostrativo.
