...
+ Visualizzazioni dati {#cja-dataviews}
   ...
   + [Campi derivati (limitati)](../data-views/derived-fields/derived-fields-limited.md)
...
+ Componenti {#cja-components}
   ...
   + Reporting in tempo reale {#real-time-reporting}
      ...
      + [Utilizzare rapporti in tempo reale](/help/components/real-time/use-real-time.md)
