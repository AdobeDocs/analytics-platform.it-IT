...
+ Customer Journey Analytics e Adobe Analytics {#compare-aa-cja}
   + Aggiornamento a Customer Journey Analytics {#upgrade-to-cja}
      ...
      + [Aggiornamento da una soluzione di analisi di terze parti](/help/getting-started/cja-upgrade/cja-upgrade-third-party-solution.md)
      ...
      + [Adobe Analytics durante e dopo un aggiornamento](/help/getting-started/cja-upgrade/cja-upgrade-fully-move.md)
...
+ Casi d’uso {#cja-usecases}
   ...
   + Visualizzazioni dati {#data-views}
      ...
      + [Casi di utilizzo dell’estensione BI (Looker)](/help/use-cases/data-views/bi-extension-usecases-looker.md)
