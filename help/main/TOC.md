...
+ Visualizzazioni dati {#cja-dataviews}
   ...
   + [Adobe Context-Aware Sessions](../data-views/context-aware-sessions.md)
...
+ Progetti Workspace {#cja-workspace}
   ...
   + Domande frequenti su Workspace {#workspace-faq}
      ...
      + [Risultati Elemento dimensione troncato](../analysis-workspace/workspace-faq/results-truncated.md)
