...
+ Note sulla versione {#releases}
  ...
  + {hide-from-toc}[Note pre-release](../release-notes/pre-release-notes.md)
...
+ Introduzione {#cja-overview}
  + Customer Journey Analytics {#cja-b2c-overview}
    ...
    + {hide-from-toc}[Confronto tra i prodotti Analytics](/help/getting-started/analytics-product-comparison.md)
...
+ Aggiornamento e confronto {#compare-aa-cja}
  ...
  + Confronto con Adobe Analytics {#cja-aa-comparison}
    ...
    + [Mappatura dei dati tra IMS](../getting-started/aa-vs-cja/mapping-data-ims-orgs.md)
  ...
  + Transizione da Google Analytics 4 {#ga-to-cja}
    + [Panoramica](/help/getting-started/ga-to-cja/home.md)
    + [Modello dati](/help/getting-started/ga-to-cja/data-model.md)
    + [Equivalenti nei rapporti](/help/getting-started/ga-to-cja/reports.md)
    + [Differenze nei dati](/help/getting-started/ga-to-cja/compare-data.md)
...
+ Mirroring dei dati {#cja-data-mirror}
  ...
  + [Guida rapida](/help/data-mirror/relational.md)
  + [Considerazioni](/help/data-mirror/considerations.md)
...
+ Visualizzazioni dati {#cja-dataviews}
  ...
  + Impostazioni dei componenti {#component-settings}
    ...
    + {hide-from-toc}[Ambito](/help/data-views/component-settings/scope.md)
...
+ Progetti Workspace {#cja-workspace}
  ...
  + Visualizzazioni {#visualizations}
    ...
    + Tabella a forma libera {#freeform-table}
      ...
      + [Includere più dimensioni](/help/analysis-workspace/visualizations/freeform-table/freeform-table-multidimensions.md)
...
+ Approfondimenti conversazione {#conversation-insights}
  + {hide-from-toc}[Panoramica](/help/conversatiion-insights/conversation-insights.md)
  + {hide-from-toc}[Configurazione](/help/conversatiion-insights/config/guided.md)
...
+ Componenti {#cja-components}
  ...
  + Segmenti {#segments}
    ...
    + [Analisi dei sottoeventi](/help/components/segments/sub-event.md)
...
+ Unione {#stitching}
  ...
  + [Abilitare l’unione delle identità](/help/stitching/use-stitching-ui.md)
  + [Convalidare l’unione delle identità](/help/stitching/validate.md)
  + [Domande frequenti](/help/stitching/faq.md)
  + B2B {#b2b}
    + {hide-from-toc}[Unione da persona a account](/help/stitching/b2b/b2b-person-to-account-stitching.md)

+ Segnalazione popolazione totale {#tpr}
  + {hide-from-toc}[Panoramica](/help/tpr/tpr.md)
  + {hide-from-toc}[Ricerche condivise](/help/tpr/shared-lookups.md)
...
+ Casi d’uso {#cja-usecases}
  ...
  + Visualizzazioni dati {#data-views}
    ...
    + Campi derivati {#derived-fields}
      + [Linee guida per i campi derivati](/help/use-cases/data-views/derived-fields/guidelines.md)
      + [Rapporto su LLM e traffico generato da IA](/help/use-cases/data-views/derived-fields/ai-traffic.md)
      + [Rapporto sugli obiettivi](/help/use-cases/data-views/derived-fields/goals-using-derived-fields.md)
...
+ Note tecniche {#technotes}
  ...
  + [ID non validi](/help/technotes/badids.md)
  + [Browser e lingua](/help/technotes/browser-language.md)
...
+ [Server MCP Customer Journey Analytics](https://developer.adobe.com/analytics-mcp/docs/cja/)
